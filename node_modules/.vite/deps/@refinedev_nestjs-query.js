import {
  lib_exports
} from "./chunk-WL7ZZ5IK.js";
import {
  lib_default
} from "./chunk-DXCP4TD6.js";
import {
  parse,
  print,
  visit
} from "./chunk-X6DXKR4P.js";
import {
  require_pluralize
} from "./chunk-RZO2CY75.js";
import "./chunk-DC6Q3SSL.js";
import {
  __commonJS,
  __toESM
...
var de = __toESM(require_build(), 1);
var D = (n) => {
  var r, i;
  return (i = (r = n == null ? void 0 : n.selectionSet) == null ? void 0 : r.selections) == null ? void 0 : i.find((e) => e.kind === "Field" && e.name.value === "nodes");
};
var w = (n) => {
  let r = [], i = true, e = 0, t = false;
  return visit(n, { Field: { enter(s) {
    if (i) {
      i = false;
      let o = D(s) ?? s;
      if (typeof o.selectionSet > "u") throw new Error("Operation must have a selection set");
...
var L = (n) => {
  ...
  return visit(n, { OperationDefinition: { enter(i) {
    i.operation === "mutation" && (r = true);
  } } }), r;
};
var M = (n, { callback: r, params: i, meta: e }, t) => {
  let s = { created: E, updated: I, deleted: P }, { resource: u, filters: o, subscriptionType: a, id: l, ids: p } = i ?? {}, d = s[t], { operation: f, query: y, variables: h, operationName: x } = d({ ids: p, id: l, resource: u, filters: o, meta: e, subscriptionType: a }), N = (_) => {
    r(_.data[f]);
  };
  return n.subscribe({ query: y, variables: h, operationName: x }, { next: N, error: console.error, complete: () => null });
};
var V = { eq: "eq", ne: "neq", lt: "lt", gt: "gt", lte: "lte", gte: "gte", in: "in", nin: "notIn" };
var k = (n, r) => {
  if (n === "contains") return { iLike: `%${r}%` };
  if (n === "ncontains") return { notILike: `%${r}%` };
  if (n === "containss") return { like: `%${r}%` };
  if (n === "ncontainss") return { notLike: `%${r}%` };
  if (n === "startswith") return { iLike: `${r}%` };
  if (n === "nstartswith") return { notILike: `${r}%` };
  if (n === "startswiths") return { like: `${r}%` };
  if (n === "nstartswiths") return { notLike: `${r}%` };
  if (n === "endswith") return { iLike: `%${r}` };
  if (n === "nendswith") return { notILike: `%${r}` };
  if (n === "endswiths") return { like: `%${r}` };
  if (n === "nendswiths") return { notLike: `%${r}` };
  if (n === "null") return { is: null };
  if (n === "nnull") return { isNot: null };
  if (n === "between") {
    if (!Array.isArray(r)) throw new Error("Between operator requires an array");
    return r.length !== 2 ? {} : { between: { lower: r[0], upper: r[1] } };
  }
  if (n === "nbetween") {
    if (!Array.isArray(r)) throw new Error("NBetween operator requires an array");
...
var v = (n) => {
  let r = {};
  return n.filter((i) => Array.isArray(i.value) && i.value.length === 0 ? false : typeof i.value == "number" ? Number.isFinite(i.value) : i.value != null).map((i) => i.operator === "and" || i.operator === "or" ? (0, import_set.default)(r, i.operator, [v(i.value)]) : "field" in i ? (0, import_set.default)(r, i.field, k(i.operator, i.value)) : {}), r;
};
var R = (n) => n.map((r) => ({ field: r.field, direction: r.order.toUpperCase() }));
var B = (n) => {
  if (n.mode === "off") return { limit: 2147483647 };
  if (n.mode === "server" && !(!n.current || !n.pageSize)) return { limit: n.pageSize, offset: (n.current - 1) * n.pageSize };
};
var E = ({ resource: n, filters: r, meta: i }) => {
  let e = (i == null ? void 0 : i.gqlQuery) ?? (i == null ? void 0 : i.gqlMutation);
  if (e) {
    let a = (0, import_camelcase2.default)((0, import_pluralize2.singular)(n), { pascalCase: true }), l = `Created${a}`, p = `created${a}`, d = `
        ...
        `, f = {};
    return r && (f.input = { filter: v(r.filter((y) => !y.field.includes("."))) }), { query: d, variables: f, operation: p, operationName: l };
  }
  let t = `created${(0, import_camelcase2.default)((0, import_pluralize2.singular)(n), { pascalCase: true })}`, s = {};
  r && (s.input = { type: (0, import_camelcase2.default)(`create_${(0, import_pluralize2.singular)(n)}_subscription_filter_input`, { pascalCase: true }), required: true, value: { filter: v(r.filter((a) => !a.field.includes("."))) } });
  let { query: u, variables: o } = O.subscription({ operation: t, fields: i.fields, variables: s });
  return { query: u, variables: o, operation: t };
};
var I = ({ id: n, resource: r, filters: i, meta: e }) => {
  let t = (e == null ? void 0 : e.gqlQuery) ?? (e == null ? void 0 : e.gqlMutation);
  if (t) {
    let l = (0, import_camelcase2.default)((0, import_pluralize2.singular)(r), { pascalCase: true }), p = `Updated${l}`, d = `updatedOne${l}`, f = `
        ...
        `, y = {};
    return i && (y.input = { filter: v(i.filter((h) => !h.field.includes("."))) }), n && (y.input = { filter: { id: { eq: n } } }), { query: f, variables: y, operation: d, operationName: p };
  }
  let s = `updatedOne${(0, import_camelcase2.default)((0, import_pluralize2.singular)(r), { pascalCase: true })}`, u = {};
  i && (u.input = { type: (0, import_camelcase2.default)(`update_one_${(0, import_pluralize2.singular)(r)}_subscription_filter_input`, { pascalCase: true }), required: true, value: { filter: v(i.filter((l) => !l.field.includes("."))) } }), n && (u.input = { type: (0, import_camelcase2.default)(`update_one_${(0, import_pluralize2.singular)(r)}_subscription_filter_input`, { pascalCase: true }), required: true, value: { filter: { id: { eq: n } } } });
  let { query: o, variables: a } = O.subscription({ operation: s, fields: e.fields, variables: u });
  return { query: o, variables: a, operation: s };
};
var P = ({ resource: n, filters: r, meta: i }) => {
  if (i != null && i.gqlQuery) {
    let o = (0, import_camelcase2.default)((0, import_pluralize2.singular)(n), { pascalCase: true }), a = `Deleted${o}`, l = `deletedOne${o}`, p = `
        ...
        `, d = {};
    return r && (d.input = { filter: v(r.filter((f) => !f.field.includes("."))) }), { query: p, variables: d, operation: l, operationName: a };
  }
  let e = `deletedOne${(0, import_camelcase2.default)((0, import_pluralize2.singular)(n), { pascalCase: true })}`, t = {};
  r && (t.input = { type: (0, import_camelcase2.default)(`delete_one_${(0, import_pluralize2.singular)(n)}_subscription_filter_input`, { pascalCase: true }), required: true, value: { filter: v(r.filter((o) => !o.field.includes("."))) } });
  let { query: s, variables: u } = O.subscription({ operation: e, fields: i.fields.filter((o) => typeof o != "object"), variables: t });
  return { query: s, variables: u, operation: e };
};
var T = (n) => ({ getList: async ({ resource: r, pagination: i, sorters: e, filters: t, meta: s }) => {
  let u = (0, import_camelcase.default)(r), o = B(i || {}), a = {}, l, p;
  if (s != null && s.gqlQuery) l = s == null ? void 0 : s.gqlQuery, p = { filter: t ? v(t) : {}, sorting: e ? R(e) : [], paging: o };
  else {
    t && (a.filter = { type: (0, import_camelcase.default)(`${(0, import_pluralize.singular)(r)}Filter`, { pascalCase: true }), required: true, value: v(t) }), e && (a.sorting = { type: (0, import_camelcase.default)(`${(0, import_pluralize.singular)(r)}Sort`, { pascalCase: true }), required: true, list: [true], value: R(e) }), o && (a.paging = { type: "OffsetPaging", required: true, value: o });
    let f = g.query({ operation: u, fields: [{ nodes: s == null ? void 0 : s.fields }, "totalCount"], variables: a });
    l = f.query, p = f.variables;
  }
  let d = await n.request(l, p);
  return { data: d[u].nodes, total: d[u].totalCount };
}, getMany: async ({ resource: r, ids: i, meta: e }) => {
  let t = (0, import_camelcase.default)(r);
  if (e != null && e.gqlQuery) return { data: (await n.request(e.gqlQuery, { filter: { id: { in: i } } }))[t].nodes };
  let { query: s, variables: u } = g.query({ operation: t, fields: [{ nodes: (e == null ? void 0 : e.fields) || ["id"] }], variables: { filter: { type: (0, import_camelcase.default)(`${(0, import_pluralize.singular)(r)}Filter`, { pascalCase: true }), required: true, value: { id: { in: i } } } } });
  return { data: (await n.request(s, u))[t].nodes };
}, create: async ({ resource: r, variables: i, meta: e }) => {
  ...
  if (s) return { data: (await n.request(s, { input: { [(0, import_camelcase.default)((0, import_pluralize.singular)(r))]: i } }))[t] };
  let { query: u, variables: o } = g.mutation({ operation: t, fields: (e == null ? void 0 : e.fields) || ["id"], variables: { input: { type: `CreateOne${(0, import_camelcase.default)((0, import_pluralize.singular)(r), { pascalCase: true })}Input`, required: true, value: { [(0, import_camelcase.default)((0, import_pluralize.singular)(r))]: i } } } });
  return { data: (await n.request(u, o))[t] };
}, createMany: async ({ resource: r, variables: i, meta: e }) => {
  let s = `createMany${(0, import_camelcase.default)(r, { pascalCase: true })}`, u = (e == null ? void 0 : e.gqlMutation) ?? (e == null ? void 0 : e.gqlQuery);
  if (u) return { data: (await n.request(u, { input: { [(0, import_camelcase.default)(r)]: i } }))[s] };
  let { query: o, variables: a } = g.mutation({ operation: s, fields: (e == null ? void 0 : e.fields) || ["id"], variables: { input: { type: `CreateMany${(0, import_camelcase.default)(r, { pascalCase: true })}Input`, required: true, value: { [(0, import_camelcase.default)(r)]: i } } } });
  return { data: (await n.request(o, a))[s] };
}, update: async ({ resource: r, id: i, variables: e, meta: t }) => {
  let s = `updateOne${(0, import_camelcase.default)((0, import_pluralize.singular)(r), { pascalCase: true })}`, u = (t == null ? void 0 : t.gqlMutation) ?? (t == null ? void 0 : t.gqlQuery);
  if (u) return { data: (await n.request(u, { input: { id: i, update: e } }))[s] };
  let { query: o, variables: a } = g.mutation({ operation: s, fields: (t == null ? void 0 : t.fields) || ["id"], variables: { input: { type: `UpdateOne${(0, import_camelcase.default)((0, import_pluralize.singular)(r), { pascalCase: true })}Input`, required: true, value: { id: i, update: e } } } });
  return { data: (await n.request(o, a))[s] };
}, updateMany: async ({ resource: r, ids: i, variables: e, meta: t }) => {
  let s = (0, import_camelcase.default)(r, { pascalCase: true }), u = `updateMany${s}`, o = lib_default`
            ...
            `;
  await n.request(o, { input: { filter: { id: { in: i } }, update: e } });
  let a = (0, import_camelcase.default)(r), l, p;
  if (t != null && t.fields) {
    let f = g.query({ operation: a, fields: [{ nodes: (t == null ? void 0 : t.fields) || ["id"] }], variables: { filter: { type: (0, import_camelcase.default)(`${(0, import_pluralize.singular)(r)}Filter`, { pascalCase: true }), required: true, value: { id: { in: i } } } } });
    l = f.query, p = f.variables;
  } else l = lib_default`
                ...
                `, p = { filter: { id: { in: i } } };
  return { data: (await n.request(l, p))[a].nodes };
}, getOne: async ({ resource: r, id: i, meta: e }) => {
  ...
  if (s) {
    ...
    return { data: (await n.request(l, p))[t] };
  }
  let { query: u, variables: o } = g.query({ operation: t, fields: (e == null ? void 0 : e.fields) || ["id"], variables: { id: { type: "ID", required: true, value: i } } });
  return { data: (await n.request(u, o))[t] };
}, deleteOne: async ({ resource: r, id: i, meta: e }) => {
  let t = (0, import_camelcase.default)((0, import_pluralize.singular)(r), { pascalCase: true }), s = `deleteOne${t}`;
  if (e != null && e.gqlMutation) return { data: (await n.request(e.gqlMutation, { input: { id: i } }))[s] };
  let u = lib_default`
                ...
                `;
  return { data: (await n.request(u, { input: { id: i } }))[s] };
}, deleteMany: async ({ resource: r, ids: i }) => {
  let e = (0, import_camelcase.default)(r, { pascalCase: true }), t = `deleteMany${e}`, s = lib_default`
            ...
            `, u = { input: { filter: { id: { in: i } } } };
  return await n.request(s, u), { data: [] };
}, getApiUrl: () => n.url, custom: async ({ url: r, method: i, headers: e, meta: t }) => {
  let s = ["get", "post"], u = r || n.url;
  if (!s.some((p) => p === i)) throw Error(`GraphQL does not support ${i} method.`);
  let o = i, a = new GraphQLClient(u, { ...n.requestConfig, method: o, headers: { ...n.requestConfig.headers, ...e } }), l = (t == null ? void 0 : t.gqlMutation) ?? (t == null ? void 0 : t.gqlQuery);
  if (l) return { data: await a.request({ document: l, variables: t == null ? void 0 : t.variables }) };
  if (t != null && t.rawQuery) return { data: await a.request({ document: t.rawQuery, variables: t.variables }) };
  if (t) {
    if (t.operation) {
      let p, d;
      if (i === "get") {
        let y = g.query({ operation: t.operation, fields: t.fields, variables: t.variables });
        p = y.query, d = y.variables;
      } else {
        let y = g.mutation({ operation: t.operation, fields: t.fields, variables: t.variables });
        p = y.query, d = y.variables;
      }
      return { data: (await a.request({ document: p, variables: d }))[t.operation] };
    }
...
var ne = (n) => {
  let r = (i, e, t, s, u, o, a) => {
    let l = M(i, { callback: e, params: t, meta: s }, u);
    a.push(l);
  };
  return { subscribe({ callback: i, params: e, meta: t }) {
    let { resource: s, subscriptionType: u } = e ?? {};
    if (!t || !u || !s) throw new Error("[useSubscription]: `meta`, `subscriptionType` and `resource` are required in `params` for graphql subscriptions");
    let o = [];
    return (e == null ? void 0 : e.subscriptionType) === "useList" && ["created", "updated", "deleted"].forEach((l) => r(n, i, e, t, l, s, o)), (e == null ? void 0 : e.subscriptionType) === "useOne" && r(n, i, e, t, "updated", s, o), () => {
      o.forEach((l) => l());
    };
  }, unsubscribe(i) {
    i();
