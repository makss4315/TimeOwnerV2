...
var D = { go: () => {
  ...
  var c;
  let t = useParams(), { pathname: o, search: r } = useLocation(), { resources: i } = (0, import_react2.useContext)(Rt), { resource: s, action: n, matchedRoute: e } = import_react.default.useMemo(() => as(o, i), [i, o]);
...
var B = (t, o) => {
  ...
  if (typeof i == "string" && o === "list") return i;
  if (typeof i == "object" && o === "list") return i.path;
  if (typeof s == "string" && o === "create") return s;
  if (typeof s == "object" && o === "create") return s.path;
  if (typeof n == "string" && o === "show") return n;
  if (typeof n == "object" && o === "show") return n.path;
  if (typeof e == "string" && o === "edit") return e;
  if (typeof e == "object" && o === "edit") return e.path;
...
var O = ({ resource: t, meta: o }) => {
  let r = Ut(), { resource: i, resources: s } = Y(t), n = i || s.find((e) => e.list);
  if (n) {
