...
import {
  require_extend,
  require_inline_style_parser,
  require_is_buffer,
  require_prop_types
} from "./chunk-P7A5GTC2.js";
import {
  Keyframes_default,
  ...
  useStyleRegister,
  version_default
} from "./chunk-TL7HH4U6.js";
import {
  require_dayjs_min
} from "./chunk-7RXIZQGQ.js";
import "./chunk-JH7L5CUN.js";
import {
  $,
  $t,
  $u,
  ...
  yo,
  yt
} from "./chunk-ZLBII7XL.js";
import "./chunk-RZO2CY75.js";
import {
  require_jsx_runtime
} from "./chunk-YPGNGA4Z.js";
import "./chunk-PHUJL5HJ.js";
import {
  __assign
} from "./chunk-DC6Q3SSL.js";
import "./chunk-6CJ73D4S.js";
import {
  ...
  noteOnce,
  require_classnames
} from "./chunk-VOPOSWZS.js";
import "./chunk-V7S77SXR.js";
import "./chunk-F5W75ND7.js";
import "./chunk-C5Z4WKZ2.js";
import {
  require_react_dom
...
var require_ast_to_react = __commonJS({
  "node_modules/react-markdown/src/ast-to-react.js"(exports) {
    ...
    function toReact(context, node, index, parent) {
      ...
      const basic = typeof component === "string" || component === React46.Fragment;
      ...
      return children.length > 0 ? React46.createElement(component, properties, children) : React46.createElement(component, properties);
    }
...
var require_react_markdown = __commonJS({
  "node_modules/react-markdown/src/react-markdown.js"(exports, module) {
    ...
    function ReactMarkdown(options) {
      ...
      let result = React46.createElement(
        React46.Fragment,
        {},
        childrenToReact({ options, schema: html, listDepth: 0 }, hastNode)
      );
      if (options.className) {
        result = React46.createElement("div", { className: options.className }, result);
      }
      return result;
    }
  ...
  "node_modules/@babel/runtime/helpers/objectWithoutProperties.js"(exports, module) {
    ...
    function _objectWithoutProperties2(e2, t) {
      ...
      if (Object.getOwnPropertySymbols) {
        ...
        for (r = 0; r < s.length; r++) o3 = s[r], t.includes(o3) || {}.propertyIsEnumerable.call(e2, o3) && (i[o3] = e2[o3]);
      }
      return i;
    }
...
var require_IconBase = __commonJS({
  "node_modules/@ant-design/icons/lib/components/IconBase.js"(exports) {
    ...
    var _objectSpread22 = _interopRequireDefault(require_objectSpread2());
    var React46 = _interopRequireWildcard(require_react());
...
var require_AntdIcon = __commonJS({
  "node_modules/@ant-design/icons/lib/components/AntdIcon.js"(exports) {
    ...
    var Icon = React46.forwardRef(function(props, ref) {
      ...
      var _React$useContext = React46.useContext(_Context.default), _React$useContext$pre = _React$useContext.prefixCls, prefixCls = _React$useContext$pre === void 0 ? "anticon" : _React$useContext$pre, rootClassName = _React$useContext.rootClassName;
      ...
      var _normalizeTwoToneColo = (0, _utils.normalizeTwoToneColors)(twoToneColor), _normalizeTwoToneColo2 = (0, _slicedToArray22.default)(_normalizeTwoToneColo, 2), primaryColor = _normalizeTwoToneColo2[0], secondaryColor = _normalizeTwoToneColo2[1];
      return React46.createElement("span", (0, _extends2.default)({
        role: "img",
      ...
      }), React46.createElement(_IconBase.default, {
        icon,
        primaryColor,
        secondaryColor,
        style: svgStyle
...
var require_ArrowLeftOutlined2 = __commonJS({
  "node_modules/@ant-design/icons/lib/icons/ArrowLeftOutlined.js"(exports) {
    ...
    var ArrowLeftOutlined2 = function ArrowLeftOutlined3(props, ref) {
      return React46.createElement(_AntdIcon.default, (0, _extends2.default)({}, props, {
        ref,
        icon: _ArrowLeftOutlined.default
      }));
    };
    var RefIcon = React46.forwardRef(ArrowLeftOutlined2);
    if (true) {
...
var require_ArrowRightOutlined2 = __commonJS({
  "node_modules/@ant-design/icons/lib/icons/ArrowRightOutlined.js"(exports) {
    ...
    var RefIcon = React46.forwardRef(ArrowRightOutlined2);
    if (true) {
  ...
  "node_modules/path-to-regexp/dist/index.js"(exports) {
    ...
    var Iter = class {
      ...
      tryConsume(type) {
        ...
        if (token2.type !== type)
          return;
        __classPrivateFieldSet(this, _Iter_peek, void 0, "f");
        return token2.value;
      }
      consume(type) {
    ...
    _Iter_peek = /* @__PURE__ */ new WeakMap();
    var TokenData = class {
      constructor(tokens) {
        this.tokens = tokens;
      }
    ...
    function $match(data, options = {}) {
      ...
      return Object.assign(function match4(input) {
        const m = re2.exec(input);
        if (!m)
          return false;
        const { 0: path } = m;
...
var setupDevTools = () => {
  if (enableDevtools) {
    window.__SWR_DEVTOOLS_REACT__ = import_react8.default;
  }
};
var normalize = (args) => {
...
var useSWRConfig = () => {
  return mergeObjects(defaultConfig, (0, import_react8.useContext)(SWRConfigContext));
};
...
// node_modules/swr/dist/core/index.mjs
var use2 = import_react9.default.use || ((promise) => {
...
var useSWRHandler = (_key, fetcher, config) => {
  ...
  const initialMountedRef = (0, import_react9.useRef)(false);
  const unmountedRef = (0, import_react9.useRef)(false);
  const keyRef = (0, import_react9.useRef)(key);
  ...
  const stateDependencies = (0, import_react9.useRef)({}).current;
  ...
  const getSnapshot = (0, import_react9.useMemo)(() => {
  ...
  const cached = (0, import_shim.useSyncExternalStore)((0, import_react9.useCallback)(
  ...
  const laggyDataRef = (0, import_react9.useRef)(data);
  ...
  const revalidate = (0, import_react9.useCallback)(
  ...
  const boundMutate = (0, import_react9.useCallback)(
  ...
  (0, import_react9.useDebugValue)(returnedData);
...
function useStyle(componentName, styleFn) {
  ...
  var _useContext = (0, import_react10.useContext)(ProProvider), _useContext$token = _useContext.token, token2 = _useContext$token === void 0 ? {} : _useContext$token;
  var _useContext2 = (0, import_react10.useContext)(ProProvider), hashed = _useContext2.hashed;
  var _useToken = useToken3(), antdToken = _useToken.token, hashId = _useToken.hashId;
  var _useContext3 = (0, import_react10.useContext)(ProProvider), provideTheme = _useContext3.theme;
  var _useContext4 = (0, import_react10.useContext)(config_provider_default.ConfigContext), getPrefixCls = _useContext4.getPrefixCls, csp = _useContext4.csp;
  if (!token2.layout) {
...
var ProConfigContext = import_react11.default.createContext({
...
function useIntl() {
  var _useContext3 = (0, import_react11.useContext)(config_provider_default.ConfigContext), locale4 = _useContext3.locale;
  var _useContext4 = (0, import_react11.useContext)(ProConfigContext), intl = _useContext4.intl;
...
var FieldLabelFunction = function FieldLabelFunction2(props, ref) {
  ...
  var _useContext = (0, import_react14.useContext)(config_provider_default.ConfigContext), getPrefixCls = _useContext.getPrefixCls;
  ...
  var intl = useIntl();
  var clearRef = (0, import_react14.useRef)(null);
  var labelRef = (0, import_react14.useRef)(null);
...
var FieldLabel = import_react14.default.forwardRef(FieldLabelFunction);
...
var LabelIconTip = import_react17.default.memo(function(props) {
  var label = props.label, tooltip = props.tooltip, ellipsis = props.ellipsis, subTitle = props.subTitle;
  var _useContext = (0, import_react17.useContext)(config_provider_default.ConfigContext), getPrefixCls = _useContext.getPrefixCls;
  ...
  var tooltipProps = typeof tooltip === "string" || import_react17.default.isValidElement(tooltip) ? {
    title: tooltip
  } : tooltip;
...
var ProFormContext = import_react18.default.createContext({});
...
var RouteContext = (0, import_react38.createContext)({});
...
var PageHeader = function PageHeader2(props) {
  ...
  var _React$useState = React17.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), compact = _React$useState2[0], updateCompact = _React$useState2[1];
  var onResize = function onResize2(_ref) {
    var width = _ref.width;
    return updateCompact(width < 768);
  };
  var _React$useContext = React17.useContext(config_provider_default.ConfigContext), getPrefixCls = _React$useContext.getPrefixCls, direction = _React$useContext.direction;
...
var MenuItemTooltip = function MenuItemTooltip2(props) {
  var _useState = (0, import_react48.useState)(props.collapsed), _useState2 = _slicedToArray(_useState, 2), collapsed = _useState2[0], setCollapsed = _useState2[1];
  var _useState3 = (0, import_react48.useState)(false), _useState4 = _slicedToArray(_useState3, 2), open = _useState4[0], setOpen = _useState4[1];
...
var _SafetyWarningProvider = import_react50.default.memo(function(props) {
  if (true) {
...
var Tag = import_react61.default.forwardRef(function(_ref, ref) {
...
var ProHelpProvide = import_react67.default.createContext({
  dataSource: [],
...
var SelectKeyProvide = import_react69.default.createContext({
  selectedKey: void 0,
...
var Pe2 = o2(({ action: e2, resource: t, onMutationSuccess: r, onMutationError: s, autoSave: n2, submitOnEnter: i = false, warnWhenUnsavedChanges: a, redirect: p, successNotification: c, errorNotification: u, meta: l, metaData: d, queryMeta: m, mutationMeta: f, liveMode: g, liveParams: y, mutationMode: b, dataProviderName: x, onLiveEvent: h, invalidates: B, undoableTimeout: C, queryOptions: S, createMutationOptions: k, updateMutationOptions: F, id: D, overtimeOptions: T, optimisticUpdateMap: v, defaultFormValues: A2, disableServerSideValidation: H = false } = {}) => {
  var _, fe;
  let { options: j } = ge(), P = (j == null ? void 0 : j.disableServerSideValidation) || H, K = $(), [$2] = form_default.useForm(), U = useForm({ form: $2, defaultFormValues: A2 }), { form: E } = U, q = xh({ onMutationSuccess: r || void 0, onMutationError: async (Z, ee, le2) => {
    if (P) {
      s == null || s(Z, ee, le2);
      return;
    }
    let ie2 = [], de = E.getFieldsValue();
    ie2 = Object.keys(Cr(de)).map((ce) => ({ name: Ts(ce), errors: void 0 })), E.setFields(ie2);
    let me = Z == null ? void 0 : Z.errors;
    for (let ce in me) {
      let ne = me[ce], Te2 = [];
      Array.isArray(ne) && (Te2 = ne), typeof ne == "string" && (Te2 = [ne]), typeof ne == "boolean" && ne && (Te2 = ["Field is not valid."]), typeof ne == "object" && "key" in ne && (Te2 = [K(ne.key, ne.message)]), ie2.push({ name: Ts(ce), errors: Te2 });
    }
    E.setFields([...ie2]), s == null || s(Z, ee, le2);
  }, redirect: p, action: e2, resource: t, successNotification: c, errorNotification: u, meta: A(l, d), metaData: A(l, d), queryMeta: m, mutationMeta: f, liveMode: g, liveParams: y, mutationMode: b, dataProviderName: x, onLiveEvent: h, invalidates: B, undoableTimeout: C, queryOptions: S, createMutationOptions: k, updateMutationOptions: F, id: D, overtimeOptions: T, optimisticUpdateMap: v, autoSave: n2 }), { formLoading: L, onFinish: O, query: M, id: Y2, onFinishAutoSave: N } = q, { warnWhenUnsavedChanges: z, setWarnWhen: w } = vt(), R = a ?? z;
  import_react75.default.useEffect(() => {
    E.resetFields();
  }, [(_ = M == null ? void 0 : M.data) == null ? void 0 : _.data, Y2]);
  let J = o2((Z) => {
    i && Z.key === "Enter" && E.submit();
  }, "onKeyUp"), X = o2((Z, ee) => {
    if (Z && R && w(true), n2 != null && n2.enabled) {
      w(false);
      let le2 = (n2 == null ? void 0 : n2.onFinish) ?? ((ie2) => ie2);
      return N(le2(ee)).catch((ie2) => ie2);
    }
    return Z;
  }, "onValuesChange"), se2 = { disabled: L, onClick: () => {
    E.submit();
  } };
  return { form: U.form, formProps: { ...U.formProps, onFinish: (Z) => O(Z).catch((ee) => ee), onKeyUp: J, onValuesChange: X, initialValues: (fe = M == null ? void 0 : M.data) == null ? void 0 : fe.data }, saveButtonProps: se2, defaultFormValuesLoading: U.defaultFormValuesLoading, ...q, onFinish: async (Z) => await O(Z ?? U.form.getFieldsValue(true)) };
}, "useForm");
var to2 = o2(({ modalProps: e2 = {} } = {}) => {
  let { show: t, close: r, visible: s } = fR({ defaultVisible: e2.open });
...
var ro = o2(({ syncWithLocation: e2, defaultVisible: t = false, autoSubmitClose: r = true, autoResetForm: s = true, autoSave: n2, invalidates: i, ...a }) => {
  var z, w;
  let [p, c] = import_react76.default.useState(false), u = Ae(), { resource: l, action: d, identifier: m } = Y(a.resource), f = Te(), g = he(), y = Pt(), b = a.action ?? d ?? "", x = !(typeof e2 == "object" && (e2 == null ? void 0 : e2.syncId) === false), h = typeof e2 == "object" && "key" in e2 ? e2.key : l && b && e2 ? `modal-${m}-${b}` : void 0, B = Pe2({ meta: { ...h ? { [h]: void 0 } : {}, ...a.meta }, autoSave: n2, invalidates: i, ...a }), { form: C, formProps: S, id: k, setId: F, formLoading: D, onFinish: T, autoSaveProps: v } = B, A2 = $(), { warnWhen: H, setWarnWhen: j } = vt(), { show: P, close: K, modalProps: $2 } = to2({ modalProps: { open: t } }), U = $2.open || false, E = { modalProps: $2, form: C, formLoading: D, formProps: S, formResult: void 0, formValues: C.getFieldsValue, defaultFormValuesLoading: false, initialValues: {}, submit: T, close: K, open: $2.open || false, show: P, visible: U };
  import_react76.default.useEffect(() => {
    var R, J, X, se2;
    if (p === false && h) {
      let _ = (J = (R = f == null ? void 0 : f.params) == null ? void 0 : R[h]) == null ? void 0 : J.open;
      if (typeof _ == "boolean" ? _ && P() : typeof _ == "string" && _ === "true" && P(), x) {
        let fe = (se2 = (X = f == null ? void 0 : f.params) == null ? void 0 : X[h]) == null ? void 0 : se2.id;
        fe && (F == null || F(fe));
      }
      c(true);
    }
  }, [h, f, x, F]), import_react76.default.useEffect(() => {
    var R;
    p === true && (U && h ? g({ query: { [h]: { ...(R = f == null ? void 0 : f.params) == null ? void 0 : R[h], open: true, ...x && k && { id: k } } }, options: { keepQuery: true }, type: "replace" }) : h && !U && g({ query: { [h]: void 0 }, options: { keepQuery: true }, type: "replace" }));
  }, [k, U, P, h, x]);
  let q = { disabled: D, loading: D, onClick: () => {
    C.submit();
  } }, L = (0, import_react76.useCallback)(() => {
    if (v.status === "success" && (n2 != null && n2.invalidateOnClose) && u({ id: k, invalidates: i || ["list", "many", "detail"], dataProviderName: a.dataProviderName, resource: m }), H) if (window.confirm(A2("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes."))) j(false);
    else return;
    F == null || F(void 0), E.close();
  }, [H, v.status]), O = (0, import_react76.useCallback)((R) => {
    typeof R < "u" && (F == null || F(R)), (!(b === "edit" || b === "clone") || (typeof R < "u" || typeof k < "u")) && E.show();
  }, [k]), { visible: M, ...Y2 } = $2, N = { open: M, ...Y2 };
  return { ...B, ...E, show: O, close: L, open: U, formProps: { ...S, ...B.formProps, onValuesChange: S == null ? void 0 : S.onValuesChange, onKeyUp: S == null ? void 0 : S.onKeyUp, onFinish: async (R) => {
    await T(R), r && K(), s && C.resetFields();
  } }, modalProps: { ...N, width: "1000px", okButtonProps: q, title: A2(`${m}.titles.${a.action}`, `${y(`${a.action} ${((z = l == null ? void 0 : l.meta) == null ? void 0 : z.label) ?? ((w = l == null ? void 0 : l.options) == null ? void 0 : w.label) ?? (l == null ? void 0 : l.label) ?? m}`, "singular")}`), okText: A2("buttons.save", "Save"), cancelText: A2("buttons.cancel", "Cancel"), onCancel: L, forceRender: true }, formLoading: D };
}, "useModalForm");
var no2 = o2(({ syncWithLocation: e2, defaultVisible: t = false, autoSubmitClose: r = true, autoResetForm: s = true, autoSave: n2, invalidates: i, ...a }) => {
  let p = Ae(), [c, u] = import_react77.default.useState(false), { visible: l, show: d, close: m } = fR({ defaultVisible: t }), { resource: f, action: g, identifier: y } = Y(a.resource), b = Te(), x = he(), h = a.action ?? g ?? "", B = !(typeof e2 == "object" && (e2 == null ? void 0 : e2.syncId) === false), C = typeof e2 == "object" && "key" in e2 ? e2.key : f && h && e2 ? `drawer-${(f == null ? void 0 : f.identifier) ?? (f == null ? void 0 : f.name)}-${h}` : void 0, S = Pe2({ meta: { ...C ? { [C]: void 0 } : {}, ...a.meta }, autoSave: n2, invalidates: i, ...a }), { form: k, formProps: F, formLoading: D, id: T, setId: v, onFinish: A2, autoSaveProps: H } = S;
  import_react77.default.useEffect(() => {
    var L, O, M, Y2;
    if (c === false && C) {
      let N = (O = (L = b == null ? void 0 : b.params) == null ? void 0 : L[C]) == null ? void 0 : O.open;
      if (typeof N == "boolean" ? N ? d() : m() : typeof N == "string" && N === "true" && d(), B) {
        let z = (Y2 = (M = b == null ? void 0 : b.params) == null ? void 0 : M[C]) == null ? void 0 : Y2.id;
        z && (v == null || v(z));
      }
      u(true);
    }
  }, [C, b, B, v, c]), import_react77.default.useEffect(() => {
    var L;
    c === true && (l && C ? x({ query: { [C]: { ...(L = b == null ? void 0 : b.params) == null ? void 0 : L[C], open: true, ...B && T && { id: T } } }, options: { keepQuery: true }, type: "replace" }) : C && !l && x({ query: { [C]: void 0 }, options: { keepQuery: true }, type: "replace" }));
  }, [T, l, d, m, C, B, c]);
  let j = $(), { warnWhen: P, setWarnWhen: K } = vt(), $2 = { disabled: D, onClick: () => {
    k.submit();
  }, loading: D }, U = { recordItemId: T, onSuccess: () => {
    v == null || v(void 0), m();
  } }, E = (0, import_react77.useCallback)(() => {
    if (H.status === "success" && (n2 != null && n2.invalidateOnClose) && p({ id: T, invalidates: i || ["list", "many", "detail"], dataProviderName: a.dataProviderName, resource: y }), P) if (window.confirm(j("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes."))) K(false);
    else return;
    m(), v == null || v(void 0);
  }, [P]), q = (0, import_react77.useCallback)((L) => {
    typeof L < "u" && (v == null || v(L)), (!(h === "edit" || h === "clone") || (typeof L < "u" || typeof T < "u")) && d();
  }, [T]);
  return { ...S, show: q, close: E, formProps: { form: k, ...S.formProps, onValuesChange: F == null ? void 0 : F.onValuesChange, onKeyUp: F == null ? void 0 : F.onKeyUp, onFinish: async (L) => {
    await A2(L), r && m(), s && k.resetFields();
  } }, drawerProps: { width: "500px", onClose: E, open: l, forceRender: true }, saveButtonProps: $2, deleteButtonProps: U, formLoading: D };
}, "useDrawerForm");
var ao = o2((e2 = {}) => {
  let t = Pe2({ ...e2 }), { form: r, formProps: s } = t, n2 = useStepsForm({ isBackValidate: false, form: r, submit: (i) => {
    var a;
...
var ft = o2((e2, t, r) => {
  ...
  return Object.keys(e2).map((i) => {
    var c, u;
    let a = e2[i], p = ((c = t.filter((l) => l.operator !== "or").find((l) => l.field === i)) == null ? void 0 : c.operator) || ((u = n2[i]) == null ? void 0 : u.operator);
    p !== "or" && p !== "and" && s.push({ field: i, operator: p ?? (Array.isArray(a) ? "in" : "eq"), value: a });
  }), s;
}, "mapAntdFilterToCrudFilter");
var Fe = o2(({ to: e2, element: t }) => {
  let { Link: r } = le(), s = se(), n2 = yt();
  return import_react79.default.createElement(s === "legacy" ? r : n2, { to: e2, replace: false, onClick: (a) => {
    a.preventDefault();
  } }, t);
}, "PaginationLink");
var gt = o2(({ onSearch: e2, initialCurrent: t, initialPageSize: r, hasPagination: s = true, pagination: n2, initialSorter: i, permanentSorter: a, initialFilter: p, permanentFilter: c, defaultSetFilterBehavior: u, filters: l, sorters: d, syncWithLocation: m, resource: f, successNotification: g, errorNotification: y, queryOptions: b, liveMode: x, onLiveEvent: h, liveParams: B, meta: C, metaData: S, dataProviderName: k } = {}) => {
  let { tableQueryResult: F, tableQuery: D, current: T, setCurrent: v, pageSize: A2, setPageSize: H, filters: j, setFilters: P, sorters: K, setSorters: $2, sorter: U, setSorter: E, createLinkForSyncWithLocation: q, pageCount: L, overtime: O } = MC({ permanentSorter: a, permanentFilter: c, initialCurrent: t, initialPageSize: r, pagination: n2, hasPagination: s, filters: l, sorters: d, initialSorter: i, initialFilter: p, syncWithLocation: m, resource: f, defaultSetFilterBehavior: u, successNotification: g, errorNotification: y, queryOptions: b, liveMode: x, onLiveEvent: h, liveParams: B, meta: A(C, S), metaData: A(C, S), dataProviderName: k }), { syncWithLocation: M } = to(), Y2 = m ?? M, N = grid_default.useBreakpoint(), [z] = form_default.useForm(), w = useForm({ form: z }), R = on(x), J = s === false ? "off" : "server", X = ((n2 == null ? void 0 : n2.mode) ?? J) !== "off", se2 = A(l == null ? void 0 : l.initial, p), { data: _, isFetched: fe, isLoading: Z } = F;
  import_react78.default.useEffect(() => {
    if (Y2) {
      let de = w.form.getFieldsValue(), te = Object.keys(de).reduce((me, ce) => {
        let ne = j.find((Te2) => "field" in Te2 && Te2.field === ce);
        return ne && (me[ce] = ne == null ? void 0 : ne.value), me;
      }, {});
      w.form.setFieldsValue(te);
    }
  }, [Y2]);
  let ee = o2((de, te, me) => {
    ...
    X && (v == null || v(de.current || 1), H == null || H(de.pageSize || 10));
    ...
    var ne;
    let ce = q({ pagination: { pageSize: A2, current: de }, sorters: K, filters: j });
    if (te === "page") return (0, import_react78.createElement)(Fe, { to: ce, element: `${de}` });
    if (te === "next" || te === "prev") return (0, import_react78.createElement)(Fe, { to: ce, element: me });
    if (te === "jump-next" || te === "jump-prev") {
      let Te2 = (ne = me == null ? void 0 : me.props) == null ? void 0 : ne.children;
      return (0, import_react78.createElement)(Fe, { to: ce, element: import_react78.Children.count(Te2) > 1 ? (0, import_react78.createElement)(import_react78.Fragment, {}, Te2) : Te2 });
    }
    return me;
  }, pageSize: A2, current: T, simple: !N.sm, position: N.sm ? ["bottomRight"] : ["bottomCenter"], total: _ == null ? void 0 : _.total } : false, "antdPagination");
  return { searchFormProps: { ...w.formProps, onFinish: le2 }, tableProps: { dataSource: _ == null ? void 0 : _.data, loading: R === "auto" ? Z : !fe, onChange: ee, pagination: ie2(), scroll: { x: true } }, tableQueryResult: F, tableQuery: D, sorters: K, sorter: U, filters: j, setSorters: $2, setSorter: E, setFilters: P, current: T, setCurrent: v, pageSize: A2, setPageSize: H, pageCount: L, createLinkForSyncWithLocation: q, overtime: O };
}, "useTable");
var qr = o2(({ autoSubmitClose: e2 = true, ...t } = {}) => {
  let r = gt({ ...t, successNotification: void 0, errorNotification: void 0 }), s = Pe2({ ...t, action: "edit", redirect: false }), { id: n2, setId: i, saveButtonProps: a } = s, p = { onClick: () => {
    i(void 0);
  } }, c = o2((l) => ({ onClick: () => i(l) }), "editButtonProps"), u = o2((l) => l === n2, "isEditing");
  return { ...r, ...s, formProps: { ...s.formProps, onFinish: async (l) => {
    let d = await s.onFinish(l);
    return e2 && i(void 0), d;
  } }, saveButtonProps: a, cancelButtonProps: p, editButtonProps: c, isEditing: u };
}, "useEditableTable");
var pm = o2((e2) => {
  let { query: t, defaultValueQuery: r, onSearch: s, options: n2 } = TC(e2);
...
var mm = o2(({ resource: e2, sort: t, sorters: r, filters: s, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: p, pagination: c, liveMode: u, defaultValue: l, selectedOptionsOrder: d, onLiveEvent: m, liveParams: f, meta: g, metaData: y, dataProviderName: b }) => {
  let { query: x, options: h } = TC({ resource: e2, sort: t, sorters: r, filters: s, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: p, pagination: c, liveMode: u, defaultValue: l, selectedOptionsOrder: d, onLiveEvent: m, liveParams: f, meta: A(g, y), metaData: A(g, y), dataProviderName: b });
  return { checkboxGroupProps: { options: h, defaultValue: l }, query: x, queryResult: x };
}, "useCheckboxGroup");
var Tm = o2(({ resource: e2, sort: t, sorters: r, filters: s, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: p, pagination: c, liveMode: u, defaultValue: l, selectedOptionsOrder: d, onLiveEvent: m, liveParams: f, meta: g, metaData: y, dataProviderName: b }) => {
  let { query: x, options: h } = TC({ resource: e2, sort: t, sorters: r, filters: s, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: p, pagination: c, liveMode: u, defaultValue: l, selectedOptionsOrder: d, onLiveEvent: m, liveParams: f, meta: A(g, y), metaData: A(g, y), dataProviderName: b });
  return { radioGroupProps: { options: h, defaultValue: l }, query: x, queryResult: x };
}, "useRadioGroup");
var Cm = o2(({ resource: e2, resourceName: t, mapData: r = o2((l) => l, "mapData"), paparseOptions: s, batchSize: n2 = Number.MAX_SAFE_INTEGER, onFinish: i, meta: a, metaData: p, dataProviderName: c, onProgress: u } = {}) => {
  let l = $(), { resource: d } = Y(e2 ?? t), { mutationResult: m, isLoading: f, handleChange: g } = pR({ resource: (d == null ? void 0 : d.identifier) ?? (d == null ? void 0 : d.name), mapData: r, paparseOptions: s, batchSize: n2, meta: A(a, p), metaData: A(a, p), dataProviderName: c, onFinish: i, onProgress: u ?? (({ totalAmount: y, processedAmount: b }) => {
    if (y > 0 && b > 0) {
      let x = import_react80.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "-7px" } }, import_react80.default.createElement(progress_default, { type: "circle", percent: Math.floor(b / y * 100), size: 50, strokeColor: "#1890ff", status: "normal" }), import_react80.default.createElement("span", { style: { marginLeft: 8, width: "100%" } }, l("notifications.importProgress", { processed: b, total: y }, `Importing: ${b}/${y}`)));
      notification_default.open({ description: x, message: null, key: `${d}-import`, duration: 0 }), b >= y, b === y && setTimeout(() => {
        notification_default.destroy(`${d}-import`);
      }, 4500);
    }
  }) });
  return { uploadProps: { onChange: g, beforeUpload: () => false, showUploadList: false, accept: ".csv" }, buttonProps: { type: "default", loading: f }, mutationResult: m, isLoading: f };
}, "useImport");
var ns = o2(({ resource: e2, initialCurrent: t, initialPageSize: r, pagination: s, hasPagination: n2 = true, initialSorter: i, permanentSorter: a, initialFilter: p, permanentFilter: c, defaultSetFilterBehavior: u, filters: l, sorters: d, onSearch: m, queryOptions: f, syncWithLocation: g, successNotification: y, errorNotification: b, liveMode: x, onLiveEvent: h, liveParams: B, meta: C, metaData: S, dataProviderName: k } = {}) => {
  let { sorters: F, sorter: D, filters: T, current: v, pageSize: A2, pageCount: H, setFilters: j, setCurrent: P, setPageSize: K, setSorter: $2, setSorters: U, createLinkForSyncWithLocation: E, tableQueryResult: q, tableQuery: L, overtime: O } = MC({ resource: e2, initialSorter: i, permanentSorter: a, initialFilter: p, permanentFilter: c, filters: l, sorters: d, defaultSetFilterBehavior: u, initialCurrent: t, initialPageSize: r, queryOptions: f, successNotification: y, errorNotification: b, liveMode: x, onLiveEvent: h, liveParams: B, meta: A(C, S), metaData: A(C, S), syncWithLocation: g, dataProviderName: k, pagination: s, hasPagination: n2 }), M = n2 === false ? "off" : "server", Y2 = ((s == null ? void 0 : s.mode) ?? M) !== "off", N = grid_default.useBreakpoint(), z = on(x), [w] = form_default.useForm(), { data: R, isFetched: J, isLoading: X } = q, se2 = o2((Z, ee) => {
    Y2 && (P(Z), K(ee || 10));
  }, "onChange"), _ = o2(async (Z) => {
    if (m) {
      let ee = await m(Z);
      return Y2 && (P == null || P(1)), j(ee);
    }
  }, "onFinish"), fe = o2(() => Y2 ? { itemRender: (Z, ee, le2) => {
    var de;
    let ie2 = E({ pagination: { pageSize: A2, current: Z }, sorters: F, filters: T });
    if (ee === "page") return (0, import_react81.createElement)(Fe, { to: ie2, element: `${Z}` });
    if (ee === "next" || ee === "prev") return (0, import_react81.createElement)(Fe, { to: ie2, element: le2 });
    if (ee === "jump-next" || ee === "jump-prev") {
      let te = (de = le2 == null ? void 0 : le2.props) == null ? void 0 : de.children;
      return (0, import_react81.createElement)(Fe, { to: ie2, element: import_react81.Children.count(te) > 1 ? (0, import_react81.createElement)(import_react81.Fragment, {}, te) : te });
    }
    return le2;
  }, pageSize: A2, current: v, simple: !N.sm, total: R == null ? void 0 : R.total, onChange: se2 } : false, "antdPagination");
  return { searchFormProps: { form: w, onFinish: _ }, listProps: { dataSource: R == null ? void 0 : R.data, loading: z === "auto" ? X : !J, pagination: fe() }, query: L, queryResult: q, filters: T, setFilters: j, sorter: D, setSorter: $2, sorters: F, setSorters: U, current: v, setCurrent: P, pageSize: A2, setPageSize: K, pageCount: H, createLinkForSyncWithLocation: E, overtime: O };
}, "useSimpleList");
var Um = o2(() => {
  let [e2, t] = (0, import_react82.useState)(false), r = (0, import_react82.useCallback)((s) => {
    ls(s.fileList).includes(true) ? t(true) : t(false);
  }, []);
  return (0, import_react82.useMemo)(() => ({ isLoading: e2, onChange: r }), [e2]);
}, "useFileUploadState");
...
var He = import_react84.default.createContext({ siderCollapsed: false, mobileSiderOpen: false, setSiderCollapsed: () => {
}, setMobileSiderOpen: () => {
} });
var xt = o2(({ children: e2, initialSiderCollapsed: t }) => {
  let [r, s] = (0, import_react84.useState)(t ?? false), [n2, i] = (0, import_react84.useState)(false);
  return import_react84.default.createElement(He.Provider, { value: { siderCollapsed: r, mobileSiderOpen: n2, setSiderCollapsed: s, setMobileSiderOpen: i } }, e2);
}, "ThemedLayoutContextProvider");
var qm = o2(() => {
  let { mobileSiderOpen: e2, siderCollapsed: t, setMobileSiderOpen: r, setSiderCollapsed: s } = (0, import_react83.useContext)(He);
  return { siderVisible: e2, setSiderVisible: r, drawerSiderVisible: t, setDrawerSiderVisible: s };
}, "useSiderVisible");
var fo2 = o2(() => {
  let { mobileSiderOpen: e2, siderCollapsed: t, setMobileSiderOpen: r, setSiderCollapsed: s } = (0, import_react85.useContext)(He);
  return { mobileSiderOpen: e2, siderCollapsed: t, setMobileSiderOpen: r, setSiderCollapsed: s };
}, "useThemedLayoutContext");
var Pt2 = o2(({ message: e2, cancelMutation: t, undoableTimeout: r }) => import_react87.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "-7px" } }, import_react87.default.createElement(progress_default, { type: "circle", percent: (r ?? 0) * 20, format: (s) => s && s / 20, size: 50, strokeColor: "#1890ff", status: "normal" }), import_react87.default.createElement("span", { style: { marginLeft: 8, width: "100%" } }, e2), import_react87.default.createElement(button_default, { style: { flexShrink: 0 }, onClick: t, disabled: r === 0, icon: import_react87.default.createElement(UndoOutlined_default, null) })), "UndoableNotification");
var ac = { open: ({ key: e2, message: t, description: r, type: s, cancelMutation: n2, undoableTimeout: i }) => {
  s === "progress" ? notification_default.open({ key: e2, description: import_react86.default.createElement(Pt2, { notificationKey: e2, message: t, cancelMutation: () => {
    n2 == null || n2(), notification_default.destroy(e2 ?? "");
  }, undoableTimeout: i }), message: null, duration: 0, closeIcon: import_react86.default.createElement(import_react86.default.Fragment, null) }) : notification_default.open({ key: e2, description: t, message: r ?? null, type: s });
}, close: (e2) => notification_default.destroy(e2) };
var ic = o2(() => {
  let { notification: e2 } = app_default.useApp(), t = "open" in e2 ? e2 : notification_default;
  return { open: ({ key: s, message: n2, description: i, type: a, cancelMutation: p, undoableTimeout: c }) => {
    a === "progress" ? t.open({ key: s, description: import_react86.default.createElement(Pt2, { notificationKey: s, message: n2, cancelMutation: () => {
      p == null || p(), t.destroy(s ?? "");
    }, undoableTimeout: c }), message: null, duration: 0, closeIcon: import_react86.default.createElement(import_react86.default.Fragment, null) }) : t.open({ key: s, description: n2, message: i ?? null, type: a });
  }, close: (s) => t.destroy(s) };
...
var Ct = o2(({ Title: e2, render: t, meta: r }) => {
  let [s, n2] = (0, import_react89.useState)(false), [i, a] = (0, import_react89.useState)(false), p = yo(), c = se(), u = yt(), { warnWhen: l, setWarnWhen: d } = vt(), { Link: m } = le(), f = c === "legacy" ? m : u, g = Ta(), y = $(), { menuItems: b, selectedKey: x, defaultOpenKeys: h } = $u({ meta: r }), B = grid_default.useBreakpoint(), { hasDashboard: C } = ge(), S = ie(), { mutate: k } = Mr({ v3LegacyAuthProviderCompatible: !!(S != null && S.isLegacy) }), F = typeof B.lg > "u" ? false : !B.lg, D = e2 ?? g ?? Ft, T = o2((E, q) => E.map((L) => {
    let { icon: O, label: M, route: Y2, key: N, name: z, children: w, parentName: R, meta: J, options: X } = L;
    if (w.length > 0) return import_react89.default.createElement(wc, { key: L.key, resource: z, action: "list", params: { resource: L } }, import_react89.default.createElement(menu_default.SubMenu, { key: L.key, icon: O ?? import_react89.default.createElement(UnorderedListOutlined_default, null), title: M }, T(w, q)));
    let se2 = N === q, _ = !(A(J == null ? void 0 : J.parent, X == null ? void 0 : X.parent, R) !== void 0 && w.length === 0);
    return import_react89.default.createElement(wc, { key: L.key, resource: z, action: "list", params: { resource: L } }, import_react89.default.createElement(menu_default.Item, { key: L.key, style: { fontWeight: se2 ? "bold" : "normal" }, icon: O ?? (_ && import_react89.default.createElement(UnorderedListOutlined_default, null)) }, import_react89.default.createElement(f, { to: Y2 ?? "" }, M), !s && se2 && import_react89.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), v = o2(() => {
    l ? window.confirm(y("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (d(false), k()) : k();
  }, "handleLogout"), A2 = p && import_react89.default.createElement(menu_default.Item, { key: "logout", onClick: v, icon: import_react89.default.createElement(LogoutOutlined_default, null) }, y("buttons.logout", "Logout")), H = C ? import_react89.default.createElement(menu_default.Item, { key: "dashboard", style: { fontWeight: x === "/" ? "bold" : "normal" }, icon: import_react89.default.createElement(DashboardOutlined_default, null) }, import_react89.default.createElement(f, { to: "/" }, y("dashboard.title", "Dashboard")), !s && x === "/" && import_react89.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, j = T(b, x), P = o2(() => t ? t({ dashboard: H, items: j, logout: A2, collapsed: s }) : import_react89.default.createElement(import_react89.default.Fragment, null, H, j, A2), "renderSider"), K = o2(() => import_react89.default.createElement(import_react89.default.Fragment, null, import_react89.default.createElement(menu_default, { theme: "dark", selectedKeys: x ? [x] : [], defaultOpenKeys: h, mode: "inline", onClick: () => {
    a(false), B.lg || n2(true);
  } }, P())), "renderMenu"), $2 = o2(() => import_react89.default.createElement(import_react89.default.Fragment, null, import_react89.default.createElement(drawer_default, { open: i, onClose: () => a(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react89.default.createElement(layout_default, null, import_react89.default.createElement(layout_default.Sider, { style: { height: "100vh", overflow: "hidden" } }, import_react89.default.createElement(D, { collapsed: false }), K()))), import_react89.default.createElement(button_default, { style: To, size: "large", onClick: () => a(true), icon: import_react89.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  return import_react89.default.createElement(config_provider_default, { theme: { components: { Menu: { colorItemBg: "transparent", colorItemText: "#fff", colorItemTextSelected: "#fff", colorItemBgSelected: "transparent", colorItemTextHover: "#fff" } } } }, o2(() => F ? $2() : import_react89.default.createElement(layout_default.Sider, { collapsible: true, collapsed: s, onCollapse: (E) => n2(E), collapsedWidth: 80, breakpoint: "lg" }, import_react89.default.createElement(D, { collapsed: s }), K()), "renderContent")());
}, "Sider");
var Bt = o2(() => {
  let e2 = ie(), { data: t } = no({ v3LegacyAuthProviderCompatible: !!(e2 != null && e2.isLegacy) });
  return t && (t.name || t.avatar) ? import_react90.default.createElement(layout_default.Header, { style: { display: "flex", justifyContent: "flex-end", alignItems: "center", padding: "0px 24px", height: "64px" } }, import_react90.default.createElement(space_default, { style: { marginLeft: "8px" } }, (t == null ? void 0 : t.name) && import_react90.default.createElement(typography_default.Text, { style: { color: "white" }, strong: true }, t.name), (t == null ? void 0 : t.avatar) && import_react90.default.createElement(avatar_default, { src: t == null ? void 0 : t.avatar, alt: t == null ? void 0 : t.name }))) : null;
}, "Header");
var zs = o2(({ children: e2, Header: t, Sider: r, Title: s, Footer: n2, OffLayoutArea: i }) => {
  let a = grid_default.useBreakpoint(), p = r ?? Ct, c = t ?? Bt, u = typeof a.sm > "u" ? true : a.sm;
  return import_react88.default.createElement(layout_default, { style: { minHeight: "100vh" } }, import_react88.default.createElement(p, { Title: s }), import_react88.default.createElement(layout_default, null, import_react88.default.createElement(c, null), import_react88.default.createElement(layout_default.Content, null, import_react88.default.createElement("div", { style: { minHeight: 360, padding: u ? 24 : 12 } }, e2), i && import_react88.default.createElement(i, null)), n2 && import_react88.default.createElement(n2, null)));
}, "Layout");
var Ft = o2(({ collapsed: e2 }) => {
  let t = se(), r = yt(), { Link: s } = le();
  return import_react91.default.createElement(t === "legacy" ? s : r, { to: "/" }, e2 ? import_react91.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center" } }, import_react91.default.createElement("img", { src: "https://refine.ams3.cdn.digitaloceanspaces.com/logo/refine-mini.svg", alt: "Refine", style: { margin: "0 auto", padding: "12px 0", maxHeight: "65.5px" } })) : import_react91.default.createElement("img", { src: "https://refine.ams3.cdn.digitaloceanspaces.com/logo/refine.svg", alt: "Refine", style: { width: "200px", padding: "12px 24px" } }));
}, "Title");
var Po = { borderTopLeftRadius: 0, borderBottomLeftRadius: 0, position: "fixed", top: 64, zIndex: 999 };
var Lt = o2(({ Title: e2, render: t, meta: r }) => {
  let { token: s } = theme_default.useToken(), [n2, i] = (0, import_react93.useState)(false), [a, p] = (0, import_react93.useState)(false), c = yo(), u = se(), l = yt(), { warnWhen: d, setWarnWhen: m } = vt(), { Link: f } = le(), g = u === "legacy" ? f : l, y = Ta(), b = $(), { menuItems: x, selectedKey: h, defaultOpenKeys: B } = $u({ meta: r }), C = grid_default.useBreakpoint(), { hasDashboard: S } = ge(), k = ie(), { mutate: F } = Mr({ v3LegacyAuthProviderCompatible: !!(k != null && k.isLegacy) }), D = typeof C.lg > "u" ? false : !C.lg, T = e2 ?? y ?? kt, v = o2((E, q) => E.map((L) => {
    let { icon: O, label: M, route: Y2, key: N, name: z, children: w, parentName: R, meta: J, options: X } = L;
    if (w.length > 0) return import_react93.default.createElement(wc, { key: L.key, resource: z, action: "list", params: { resource: L } }, import_react93.default.createElement(menu_default.SubMenu, { key: L.key, icon: O ?? import_react93.default.createElement(UnorderedListOutlined_default, null), title: M }, v(w, q)));
    let se2 = N === q, _ = !(A(J == null ? void 0 : J.parent, X == null ? void 0 : X.parent, R) !== void 0 && w.length === 0);
    return import_react93.default.createElement(wc, { key: L.key, resource: z, action: "list", params: { resource: L } }, import_react93.default.createElement(menu_default.Item, { key: L.key, icon: O ?? (_ && import_react93.default.createElement(UnorderedListOutlined_default, null)) }, import_react93.default.createElement(g, { to: Y2 ?? "" }, M), !n2 && se2 && import_react93.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), A2 = o2(() => {
    d ? window.confirm(b("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (m(false), F()) : F();
  }, "handleLogout"), H = c && import_react93.default.createElement(menu_default.Item, { key: "logout", onClick: () => A2(), icon: import_react93.default.createElement(LogoutOutlined_default, null) }, b("buttons.logout", "Logout")), j = S ? import_react93.default.createElement(menu_default.Item, { key: "dashboard", icon: import_react93.default.createElement(DashboardOutlined_default, null) }, import_react93.default.createElement(g, { to: "/" }, b("dashboard.title", "Dashboard")), !n2 && h === "/" && import_react93.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, P = v(x, h), K = o2(() => t ? t({ dashboard: j, items: P, logout: H, collapsed: n2 }) : import_react93.default.createElement(import_react93.default.Fragment, null, j, P, H), "renderSider"), $2 = o2(() => import_react93.default.createElement(import_react93.default.Fragment, null, import_react93.default.createElement(menu_default, { selectedKeys: h ? [h] : [], defaultOpenKeys: B, mode: "inline", style: { marginTop: "8px", border: "none" }, onClick: () => {
    p(false), C.lg || i(true);
  } }, K())), "renderMenu"), U = o2(() => import_react93.default.createElement(import_react93.default.Fragment, null, import_react93.default.createElement(drawer_default, { open: a, onClose: () => p(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react93.default.createElement(layout_default, null, import_react93.default.createElement(layout_default.Sider, { style: { height: "100vh", overflow: "hidden", backgroundColor: s.colorBgContainer, borderRight: `1px solid ${s.colorBgElevated}` } }, import_react93.default.createElement("div", { style: { width: "200px", padding: "0 16px", display: "flex", justifyContent: "flex-start", alignItems: "center", height: "64px", backgroundColor: s.colorBgElevated } }, import_react93.default.createElement(T, { collapsed: false })), $2()))), import_react93.default.createElement(button_default, { style: Po, size: "large", onClick: () => p(true), icon: import_react93.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  return D ? U() : import_react93.default.createElement(layout_default.Sider, { style: { backgroundColor: s.colorBgContainer, borderRight: `1px solid ${s.colorBgElevated}` }, collapsible: true, collapsed: n2, onCollapse: (E) => i(E), collapsedWidth: 80, breakpoint: "lg", trigger: import_react93.default.createElement(button_default, { type: "text", style: { borderRadius: 0, height: "100%", width: "100%", backgroundColor: s.colorBgElevated } }, n2 ? import_react93.default.createElement(RightOutlined_default, { style: { color: s.colorPrimary } }) : import_react93.default.createElement(LeftOutlined_default, { style: { color: s.colorPrimary } })) }, import_react93.default.createElement("div", { style: { width: n2 ? "80px" : "200px", padding: n2 ? "0" : "0 16px", display: "flex", justifyContent: n2 ? "center" : "flex-start", alignItems: "center", height: "64px", backgroundColor: s.colorBgElevated, fontSize: "14px" } }, import_react93.default.createElement(T, { collapsed: n2 })), $2());
}, "ThemedSider");
var Dt = o2(() => {
  let { token: e2 } = theme_default.useToken(), t = ie(), { data: r } = no({ v3LegacyAuthProviderCompatible: !!(t != null && t.isLegacy) });
  return r && (r.name || r.avatar) ? import_react94.default.createElement(layout_default.Header, { style: { backgroundColor: e2.colorBgElevated, display: "flex", justifyContent: "flex-end", alignItems: "center", padding: "0px 24px", height: "64px" } }, import_react94.default.createElement(space_default, null, import_react94.default.createElement(space_default, { size: "middle" }, (r == null ? void 0 : r.name) && import_react94.default.createElement(typography_default.Text, { strong: true }, r.name), (r == null ? void 0 : r.avatar) && import_react94.default.createElement(avatar_default, { src: r == null ? void 0 : r.avatar, alt: r == null ? void 0 : r.name })))) : null;
}, "ThemedHeader");
var Pn = o2(({ children: e2, Header: t, Sider: r, Title: s, Footer: n2, OffLayoutArea: i }) => {
  let a = grid_default.useBreakpoint(), p = r ?? Lt, c = t ?? Dt, u = typeof a.sm > "u" ? true : a.sm;
  return import_react92.default.createElement(layout_default, { style: { minHeight: "100vh" } }, import_react92.default.createElement(p, { Title: s }), import_react92.default.createElement(layout_default, null, import_react92.default.createElement(c, null), import_react92.default.createElement(layout_default.Content, null, import_react92.default.createElement("div", { style: { minHeight: 360, padding: u ? 24 : 12 } }, e2), i && import_react92.default.createElement(i, null)), n2 && import_react92.default.createElement(n2, null)));
}, "ThemedLayout");
var Ln = "Refine Project";
var kn = import_react95.default.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, import_react95.default.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M13.7889 0.422291C12.6627 -0.140764 11.3373 -0.140764 10.2111 0.422291L2.21115 4.42229C0.85601 5.09986 0 6.48491 0 8V16C0 17.5151 0.85601 18.9001 2.21115 19.5777L10.2111 23.5777C11.3373 24.1408 12.6627 24.1408 13.7889 23.5777L21.7889 19.5777C23.144 18.9001 24 17.5151 24 16V8C24 6.48491 23.144 5.09986 21.7889 4.42229L13.7889 0.422291ZM8 8C8 5.79086 9.79086 4 12 4C14.2091 4 16 5.79086 16 8V16C16 18.2091 14.2091 20 12 20C9.79086 20 8 18.2091 8 16V8Z", fill: "currentColor" }), import_react95.default.createElement("path", { d: "M14 8C14 9.10457 13.1046 10 12 10C10.8954 10 10 9.10457 10 8C10 6.89543 10.8954 6 12 6C13.1046 6 14 6.89543 14 8Z", fill: "currentColor" }));
var kt = o2(({ collapsed: e2, icon: t = kn, text: r = Ln, wrapperStyles: s }) => {
  let { token: n2 } = theme_default.useToken(), i = se(), a = yt(), { Link: p } = le();
  return import_react95.default.createElement(i === "legacy" ? p : a, { to: "/", style: { display: "inline-block", textDecoration: "none" } }, import_react95.default.createElement(space_default, { style: { display: "flex", alignItems: "center", fontSize: "inherit", ...s } }, import_react95.default.createElement("div", { style: { height: "24px", width: "24px", color: n2.colorPrimary } }, t), !e2 && import_react95.default.createElement(typography_default.Title, { style: { fontSize: "inherit", marginBottom: 0, fontWeight: 700 } }, r)));
}, "ThemedTitle");
...
var Rt = o2(({ Title: e2, render: t, meta: r, fixed: s, activeItemDisabled: n2 = false }) => {
  var Y2;
  let { token: i } = theme_default.useToken(), { siderCollapsed: a, setSiderCollapsed: p, mobileSiderOpen: c, setMobileSiderOpen: u } = fo2(), l = yo(), d = (Y2 = (0, import_react97.useContext)(config_provider_default.ConfigContext)) == null ? void 0 : Y2.direction, m = se(), f = yt(), { warnWhen: g, setWarnWhen: y } = vt(), { Link: b } = le(), x = m === "legacy" ? b : f, h = Ta(), B = $(), { menuItems: C, selectedKey: S, defaultOpenKeys: k } = $u({ meta: r }), F = grid_default.useBreakpoint(), { hasDashboard: D } = ge(), T = ie(), { mutate: v } = Mr({ v3LegacyAuthProviderCompatible: !!(T != null && T.isLegacy) }), A2 = typeof F.lg > "u" ? false : !F.lg, H = e2 ?? h ?? be, j = o2((N, z) => N.map((w) => {
    let { icon: R, label: J, route: X, key: se2, name: _, children: fe, parentName: Z, meta: ee, options: le2 } = w;
    if (fe.length > 0) return import_react97.default.createElement(wc, { key: w.key, resource: _, action: "list", params: { resource: w } }, import_react97.default.createElement(menu_default.SubMenu, { key: w.key, icon: R ?? import_react97.default.createElement(UnorderedListOutlined_default, null), title: J }, j(fe, z)));
    let ie2 = se2 === z, de = !(A(ee == null ? void 0 : ee.parent, le2 == null ? void 0 : le2.parent, Z) !== void 0 && fe.length === 0), te = n2 && ie2 ? { pointerEvents: "none" } : {};
    return import_react97.default.createElement(wc, { key: w.key, resource: _, action: "list", params: { resource: w } }, import_react97.default.createElement(menu_default.Item, { key: w.key, icon: R ?? (de && import_react97.default.createElement(UnorderedListOutlined_default, null)), style: te }, import_react97.default.createElement(x, { to: X ?? "", style: te }, J), !a && ie2 && import_react97.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), P = o2(() => {
    g ? window.confirm(B("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (y(false), v()) : v();
  }, "handleLogout"), K = l && import_react97.default.createElement(menu_default.Item, { key: "logout", onClick: () => P(), icon: import_react97.default.createElement(LogoutOutlined_default, null) }, B("buttons.logout", "Logout")), $2 = D ? import_react97.default.createElement(menu_default.Item, { key: "dashboard", icon: import_react97.default.createElement(DashboardOutlined_default, null) }, import_react97.default.createElement(x, { to: "/" }, B("dashboard.title", "Dashboard")), !a && S === "/" && import_react97.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, U = j(C, S), E = o2(() => t ? t({ dashboard: $2, items: U, logout: K, collapsed: a }) : import_react97.default.createElement(import_react97.default.Fragment, null, $2, U, K), "renderSider"), q = o2(() => import_react97.default.createElement(menu_default, { selectedKeys: S ? [S] : [], defaultOpenKeys: k, mode: "inline", style: { paddingTop: "8px", border: "none", overflow: "auto", height: "calc(100% - 72px)" }, onClick: () => {
    u(false);
  } }, E()), "renderMenu"), L = o2(() => import_react97.default.createElement(import_react97.default.Fragment, null, import_react97.default.createElement(drawer_default, { open: c, onClose: () => u(false), placement: d === "rtl" ? "right" : "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react97.default.createElement(layout_default, null, import_react97.default.createElement(layout_default.Sider, { style: { height: "100vh", backgroundColor: i.colorBgContainer, borderRight: `1px solid ${i.colorBgElevated}` } }, import_react97.default.createElement("div", { style: { width: "200px", padding: "0 16px", display: "flex", justifyContent: "flex-start", alignItems: "center", height: "64px", backgroundColor: i.colorBgElevated } }, import_react97.default.createElement(H, { collapsed: false })), q()))), import_react97.default.createElement(button_default, { style: vo, size: "large", onClick: () => u(true), icon: import_react97.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  if (A2) return L();
  ...
  let M = o2(() => {
    ...
    return import_react97.default.createElement(a ? d === "rtl" ? LeftOutlined_default : RightOutlined_default : d === "rtl" ? RightOutlined_default : LeftOutlined_default, { ...N });
  }, "renderClosingIcons");
  return import_react97.default.createElement(import_react97.default.Fragment, null, s && import_react97.default.createElement("div", { style: { width: a ? "80px" : "200px", transition: "all 0.2s" } }), import_react97.default.createElement(layout_default.Sider, { style: O, collapsible: true, collapsed: a, onCollapse: (N, z) => {
    z === "clickTrigger" && p(N);
  }, collapsedWidth: 80, breakpoint: "lg", trigger: import_react97.default.createElement(button_default, { type: "text", style: { borderRadius: 0, height: "100%", width: "100%", backgroundColor: i.colorBgElevated } }, M()) }, import_react97.default.createElement("div", { style: { width: a ? "80px" : "200px", padding: a ? "0" : "0 16px", display: "flex", justifyContent: a ? "center" : "flex-start", alignItems: "center", height: "64px", backgroundColor: i.colorBgElevated, fontSize: "14px" } }, import_react97.default.createElement(H, { collapsed: a })), q()));
}, "ThemedSiderV2");
var It = o2(({ isSticky: e2, sticky: t }) => {
  ...
  return A(t, e2) && (a.position = "sticky", a.top = 0, a.zIndex = 1), import_react98.default.createElement(layout_default.Header, { style: a }, import_react98.default.createElement(space_default, null, import_react98.default.createElement(space_default, { size: "middle" }, (n2 == null ? void 0 : n2.name) && import_react98.default.createElement(typography_default.Text, { strong: true }, n2.name), (n2 == null ? void 0 : n2.avatar) && import_react98.default.createElement(avatar_default, { src: n2 == null ? void 0 : n2.avatar, alt: n2 == null ? void 0 : n2.name }))));
}, "ThemedHeaderV2");
var ra = o2(({ children: e2, Header: t, Sider: r, Title: s, Footer: n2, OffLayoutArea: i, initialSiderCollapsed: a }) => {
  let p = grid_default.useBreakpoint(), c = r ?? Rt, u = t ?? It, l = typeof p.sm > "u" ? true : p.sm, d = !!c({ Title: s });
  return import_react96.default.createElement(xt, { initialSiderCollapsed: a }, import_react96.default.createElement(layout_default, { style: { minHeight: "100vh" }, hasSider: d }, import_react96.default.createElement(c, { Title: s }), import_react96.default.createElement(layout_default, null, import_react96.default.createElement(u, null), import_react96.default.createElement(layout_default.Content, null, import_react96.default.createElement("div", { style: { minHeight: 360, padding: l ? 24 : 12 } }, e2), i && import_react96.default.createElement(i, null)), n2 && import_react96.default.createElement(n2, null))));
}, "ThemedLayoutV2");
var be = o2(({ collapsed: e2, icon: t, text: r, wrapperStyles: s }) => {
  let { title: { icon: n2, text: i } = {} } = At(), a = typeof t > "u" ? n2 : t, p = typeof r > "u" ? i : r, { token: c } = theme_default.useToken(), u = se(), l = yt(), { Link: d } = le();
  return import_react99.default.createElement(u === "legacy" ? d : l, { to: "/", style: { display: "inline-block", textDecoration: "none" } }, import_react99.default.createElement(space_default, { style: { display: "flex", alignItems: "center", fontSize: "inherit", ...s } }, import_react99.default.createElement("div", { style: { height: "24px", width: "24px", color: c.colorPrimary } }, a), !e2 && import_react99.default.createElement(typography_default.Title, { style: { fontSize: "inherit", marginBottom: 0, fontWeight: 700 } }, p)));
}, "ThemedTitleV2");
var Ht = o2(({ resource: e2, resourceNameOrRouteName: t, hideText: r = false, accessControl: s, meta: n2, children: i, onClick: a, ...p }) => {
  let { hidden: c, disabled: u, label: l, title: d, LinkComponent: m, to: f } = Yv({ resource: e2 ?? t, accessControl: s, meta: n2 });
  return c ? null : import_react100.default.createElement(m, { to: f, replace: false, onClick: (g) => {
    if (u) {
      g.preventDefault();
      return;
    }
    a && (g.preventDefault(), a(g));
  } }, import_react100.default.createElement(button_default, { icon: import_react100.default.createElement(PlusSquareOutlined_default, null), disabled: u, title: d, className: n.CreateButton, type: "primary", ...p }, !r && (i ?? l)));
}, "CreateButton");
var Ot = o2(({ resource: e2, resourceNameOrRouteName: t, recordItemId: r, hideText: s = false, accessControl: n2, meta: i, children: a, onClick: p, ...c }) => {
  let { to: u, label: l, title: d, hidden: m, disabled: f, LinkComponent: g } = Xv({ resource: e2 ?? t, id: r, meta: i, accessControl: n2 });
  return m ? null : import_react101.default.createElement(g, { to: u, replace: false, onClick: (y) => {
    if (f) {
      y.preventDefault();
      return;
    }
    p && (y.preventDefault(), p(y));
  } }, import_react101.default.createElement(button_default, { icon: import_react101.default.createElement(EditOutlined_default, null), disabled: f, title: d, className: n.EditButton, ...c }, !s && (a ?? l)));
}, "EditButton");
var Ye = o2(({ resource: e2, resourceNameOrRouteName: t, recordItemId: r, onSuccess: s, mutationMode: n2, children: i, successNotification: a, errorNotification: p, hideText: c = false, accessControl: u, metaData: l, meta: d, dataProviderName: m, confirmTitle: f, confirmOkText: g, confirmCancelText: y, invalidates: b, ...x }) => {
  let { title: h, label: B, hidden: C, disabled: S, loading: k, confirmTitle: F, confirmOkLabel: D, cancelLabel: T, onConfirm: v } = Yu({ resource: e2 ?? t, id: r, dataProviderName: m, invalidates: b, meta: d, onSuccess: s, mutationMode: n2, errorNotification: p, successNotification: a, accessControl: u });
  return C ? null : import_react102.default.createElement(popconfirm_default, { key: "delete", okText: g ?? D, cancelText: y ?? T, okType: "danger", title: f ?? F, okButtonProps: { disabled: k }, onConfirm: v, disabled: typeof (x == null ? void 0 : x.disabled) < "u" ? x.disabled : S }, import_react102.default.createElement(button_default, { danger: true, loading: k, icon: import_react102.default.createElement(DeleteOutlined_default, null), title: h, disabled: S, className: n.DeleteButton, ...x }, !c && (i ?? B)));
}, "DeleteButton");
var _e2 = o2(({ resource: e2, resourceNameOrRouteName: t, recordItemId: r, hideText: s = false, dataProviderName: n2, children: i, meta: a, metaData: p, ...c }) => {
  let { onClick: u, label: l, loading: d } = qu({ resource: e2 ?? t, id: r, dataProviderName: n2 });
  return import_react103.default.createElement(button_default, { onClick: u, icon: import_react103.default.createElement(RedoOutlined_default, { spin: d }), className: n.RefreshButton, ...c }, !s && (i ?? l));
}, "RefreshButton");
var Aa = o2(({ resource: e2, resourceNameOrRouteName: t, recordItemId: r, hideText: s = false, accessControl: n2, meta: i, children: a, onClick: p, ...c }) => {
  let { to: u, label: l, title: d, hidden: m, disabled: f, LinkComponent: g } = jv({ resource: e2 ?? t, id: r, accessControl: n2, meta: i });
  return m ? null : import_react104.default.createElement(g, { to: u, replace: false, onClick: (y) => {
    if (f) {
      y.preventDefault();
      return;
    }
    p && (y.preventDefault(), p(y));
  } }, import_react104.default.createElement(button_default, { icon: import_react104.default.createElement(EyeOutlined_default, null), disabled: f, title: d, className: n.ShowButton, ...c }, !s && (a ?? l)));
}, "ShowButton");
var Ze = o2(({ resource: e2, resourceNameOrRouteName: t, hideText: r = false, accessControl: s, meta: n2, children: i, onClick: a, ...p }) => {
  let { to: c, label: u, title: l, hidden: d, disabled: m, LinkComponent: f } = Jv({ resource: e2 ?? t, accessControl: s, meta: n2 });
  return d ? null : import_react105.default.createElement(f, { to: c, replace: false, onClick: (g) => {
    if (m) {
      g.preventDefault();
      return;
    }
    a && (g.preventDefault(), a(g));
  } }, import_react105.default.createElement(button_default, { icon: import_react105.default.createElement(BarsOutlined_default, null), disabled: m, title: l, className: n.ListButton, ...p }, !r && (i ?? u)));
}, "ListButton");
var $a = o2(({ hideText: e2 = false, children: t, ...r }) => {
  let { label: s } = eD();
  return import_react106.default.createElement(button_default, { type: "default", icon: import_react106.default.createElement(ExportOutlined_default, null), className: n.ExportButton, ...r }, !e2 && (t ?? s));
}, "ExportButton");
var Xe = o2(({ hideText: e2 = false, children: t, ...r }) => {
  let { label: s } = qv();
  return import_react107.default.createElement(button_default, { type: "primary", icon: import_react107.default.createElement(SaveOutlined_default, null), className: n.SaveButton, ...r }, !e2 && (t ?? s));
}, "SaveButton");
var ni = o2(({ resourceNameOrRouteName: e2, resource: t, recordItemId: r, hideText: s = false, accessControl: n2, meta: i, children: a, onClick: p, ...c }) => {
  let { to: u, LinkComponent: l, label: d, disabled: m, hidden: f, title: g } = Zv({ id: r, resource: t ?? e2, accessControl: n2, meta: i });
  return f ? null : import_react108.default.createElement(l, { to: u, replace: false, onClick: (y) => {
    if (m) {
      y.preventDefault();
      return;
    }
    p && (y.preventDefault(), p(y));
  } }, import_react108.default.createElement(button_default, { icon: import_react108.default.createElement(PlusSquareOutlined_default, null), disabled: m, title: g, className: n.CloneButton, ...c }, !s && (a ?? d)));
}, "CloneButton");
var mi = o2(({ uploadProps: e2, buttonProps: t, hideText: r = false, children: s, loading: n2 }) => {
  let { label: i } = tD();
  return import_react109.default.createElement(upload_default, { ...e2 }, import_react109.default.createElement(button_default, { icon: import_react109.default.createElement(ImportOutlined_default, null), className: n.ImportButton, loading: n2, ...t }, !r && (s ?? i)));
}, "ImportButton");
var xi = o2(({ canCreate: e2, title: t, children: r, createButtonProps: s, resource: n2, wrapperProps: i, contentProps: a, headerProps: p, breadcrumb: c, headerButtonProps: u, headerButtons: l }) => {
  var S, k;
  let d = $(), { options: { breadcrumb: m } = {} } = ge(), f = se(), g = Pt(), { resource: y, identifier: b } = Y(n2), x = e2 ?? (((y == null ? void 0 : y.canCreate) ?? !!(y != null && y.create)) || s), h = typeof c > "u" ? m : c, B = x ? { size: "middle", resource: f === "legacy" ? y == null ? void 0 : y.route : b, ...s } : void 0, C = x ? import_react110.default.createElement(Ht, { ...B }) : null;
  return import_react110.default.createElement("div", { ...i ?? {} }, import_react110.default.createElement(ke, { title: t ?? d(`${b}.titles.list`, g(((S = y == null ? void 0 : y.meta) == null ? void 0 : S.label) ?? ((k = y == null ? void 0 : y.options) == null ? void 0 : k.label) ?? (y == null ? void 0 : y.label) ?? b, "plural")), extra: l ? import_react110.default.createElement(space_default, { wrap: true, ...u }, typeof l == "function" ? l({ defaultButtons: C, createButtonProps: B }) : l) : C, breadcrumb: typeof h < "u" ? import_react110.default.createElement(import_react110.default.Fragment, null, h) ?? void 0 : import_react110.default.createElement(Le, null), ...p ?? {} }, import_react110.default.createElement("div", { ...a ?? {} }, r)));
}, "List");
var Di = o2(({ title: e2, saveButtonProps: t, children: r, resource: s, isLoading: n2 = false, breadcrumb: i, wrapperProps: a, headerProps: p, contentProps: c, headerButtonProps: u, headerButtons: l, footerButtonProps: d, footerButtons: m, goBack: f }) => {
  var v, A2;
  let g = $(), { options: { breadcrumb: y } = {} } = ge(), b = se(), x = Mo(), { goBack: h } = Pe(), B = Pt(), { resource: C, action: S, identifier: k } = Y(s), F = typeof i > "u" ? y : i, D = { ...n2 ? { disabled: true } : {}, ...t, htmlType: "submit" }, T = import_react111.default.createElement(import_react111.default.Fragment, null, import_react111.default.createElement(Xe, { ...D }));
  return import_react111.default.createElement("div", { ...a ?? {} }, import_react111.default.createElement(ke, { backIcon: f, onBack: S !== "list" || typeof S < "u" ? b === "legacy" ? h : x : void 0, title: e2 ?? g(`${k}.titles.create`, `Create ${B(((v = C == null ? void 0 : C.meta) == null ? void 0 : v.label) ?? ((A2 = C == null ? void 0 : C.options) == null ? void 0 : A2.label) ?? (C == null ? void 0 : C.label) ?? k, "singular")}`), breadcrumb: typeof F < "u" ? import_react111.default.createElement(import_react111.default.Fragment, null, F) ?? void 0 : import_react111.default.createElement(Le, null), extra: import_react111.default.createElement(space_default, { wrap: true, ...u ?? {} }, l ? typeof l == "function" ? l({ defaultButtons: null }) : l : null), ...p ?? {} }, import_react111.default.createElement(spin_default, { spinning: n2 }, import_react111.default.createElement(card_default, { bordered: false, actions: [import_react111.default.createElement(space_default, { key: "action-buttons", style: { float: "right", marginRight: 24 }, ...d ?? {} }, m ? typeof m == "function" ? m({ defaultButtons: T, saveButtonProps: D }) : m : T)], ...c ?? {} }, r))));
}, "Create");
var zi = o2(({ title: e2, saveButtonProps: t, mutationMode: r, recordItemId: s, children: n2, deleteButtonProps: i, canDelete: a, resource: p, isLoading: c = false, dataProviderName: u, breadcrumb: l, wrapperProps: d, headerProps: m, contentProps: f, headerButtonProps: g, headerButtons: y, footerButtonProps: b, footerButtons: x, goBack: h, autoSaveProps: B }) => {
  var X, se2, _;
  let C = $(), { options: { breadcrumb: S } = {} } = ge(), { mutationMode: k } = _e(), F = r ?? k, D = se(), T = Mo(), v = he(), { goBack: A2, list: H } = Pe(), j = Pt(), { resource: P, action: K, id: $2, identifier: U } = Y(p), E = bu({ resource: P, action: "list" }), q = s ?? $2, L = typeof l > "u" ? S : l, O = (P == null ? void 0 : P.list) && !s, M = a ?? ((((X = P == null ? void 0 : P.meta) == null ? void 0 : X.canDelete) ?? (P == null ? void 0 : P.canDelete)) || i), Y2 = O ? { ...c ? { disabled: true } : {}, resource: D === "legacy" ? P == null ? void 0 : P.route : U } : void 0, N = { ...c ? { disabled: true } : {}, resource: D === "legacy" ? P == null ? void 0 : P.route : U, recordItemId: q, dataProviderName: u }, z = M ? { ...c ? { disabled: true } : {}, resource: D === "legacy" ? P == null ? void 0 : P.route : U, mutationMode: F, onSuccess: () => {
    D === "legacy" ? H((P == null ? void 0 : P.route) ?? (P == null ? void 0 : P.name) ?? "") : v({ to: E });
  }, recordItemId: q, dataProviderName: u, ...i } : void 0, w = { ...c ? { disabled: true } : {}, ...t }, R = import_react112.default.createElement(import_react112.default.Fragment, null, B && import_react112.default.createElement(Oo, { ...B }), O && import_react112.default.createElement(Ze, { ...Y2 }), import_react112.default.createElement(_e2, { ...N })), J = import_react112.default.createElement(import_react112.default.Fragment, null, M && import_react112.default.createElement(Ye, { ...z }), import_react112.default.createElement(Xe, { ...w }));
  return import_react112.default.createElement("div", { ...d ?? {} }, import_react112.default.createElement(ke, { backIcon: h, onBack: K !== "list" && typeof K < "u" ? D === "legacy" ? A2 : T : void 0, title: e2 ?? C(`${U}.titles.edit`, `Edit ${j(((se2 = P == null ? void 0 : P.meta) == null ? void 0 : se2.label) ?? ((_ = P == null ? void 0 : P.options) == null ? void 0 : _.label) ?? (P == null ? void 0 : P.label) ?? U, "singular")}`), extra: import_react112.default.createElement(space_default, { wrap: true, ...g ?? {} }, y ? typeof y == "function" ? y({ defaultButtons: R, listButtonProps: Y2, refreshButtonProps: N }) : y : R), breadcrumb: typeof L < "u" ? import_react112.default.createElement(import_react112.default.Fragment, null, L) ?? void 0 : import_react112.default.createElement(Le, null), ...m ?? {} }, import_react112.default.createElement(spin_default, { spinning: c }, import_react112.default.createElement(card_default, { bordered: false, actions: [import_react112.default.createElement(space_default, { key: "footer-buttons", wrap: true, style: { float: "right", marginRight: 24 }, ...b ?? {} }, x ? typeof x == "function" ? x({ defaultButtons: J, deleteButtonProps: z, saveButtonProps: w }) : x : J)], ...f ?? {} }, n2))));
}, "Edit");
var ep = o2(({ title: e2, canEdit: t, canDelete: r, isLoading: s = false, children: n2, resource: i, recordItemId: a, dataProviderName: p, breadcrumb: c, contentProps: u, headerProps: l, wrapperProps: d, headerButtons: m, footerButtons: f, footerButtonProps: g, headerButtonProps: y, goBack: b }) => {
  var N, z, w;
  let x = $(), { options: { breadcrumb: h } = {} } = ge(), B = se(), C = Mo(), S = he(), { goBack: k, list: F } = Pe(), D = Pt(), { resource: T, action: v, id: A2, identifier: H } = Y(i), j = bu({ resource: T, action: "list" }), P = a ?? A2, K = typeof c > "u" ? h : c, $2 = (T == null ? void 0 : T.list) && !a, U = r ?? ((N = T == null ? void 0 : T.meta) == null ? void 0 : N.canDelete) ?? (T == null ? void 0 : T.canDelete), E = t ?? (T == null ? void 0 : T.canEdit) ?? !!(T != null && T.edit), q = $2 ? { resource: B === "legacy" ? T == null ? void 0 : T.route : H } : void 0, L = E ? { ...s ? { disabled: true } : {}, type: "primary", resource: B === "legacy" ? T == null ? void 0 : T.route : H, recordItemId: P } : void 0, O = U ? { ...s ? { disabled: true } : {}, resource: B === "legacy" ? T == null ? void 0 : T.route : H, recordItemId: P, onSuccess: () => {
    B === "legacy" ? F((T == null ? void 0 : T.route) ?? (T == null ? void 0 : T.name) ?? "") : S({ to: j });
  }, dataProviderName: p } : void 0, M = { ...s ? { disabled: true } : {}, resource: B === "legacy" ? T == null ? void 0 : T.route : H, recordItemId: P, dataProviderName: p }, Y2 = import_react113.default.createElement(import_react113.default.Fragment, null, $2 && import_react113.default.createElement(Ze, { ...q }), E && import_react113.default.createElement(Ot, { ...L }), U && import_react113.default.createElement(Ye, { ...O }), import_react113.default.createElement(_e2, { ...M }));
  return import_react113.default.createElement("div", { ...d ?? {} }, import_react113.default.createElement(ke, { backIcon: b, onBack: v !== "list" && typeof v < "u" ? B === "legacy" ? k : C : void 0, title: e2 ?? x(`${H}.titles.show`, `Show ${D(((z = T == null ? void 0 : T.meta) == null ? void 0 : z.label) ?? ((w = T == null ? void 0 : T.options) == null ? void 0 : w.label) ?? (T == null ? void 0 : T.label) ?? H, "singular")}`), extra: import_react113.default.createElement(space_default, { key: "extra-buttons", wrap: true, ...y ?? {} }, m ? typeof m == "function" ? m({ defaultButtons: Y2, deleteButtonProps: O, editButtonProps: L, listButtonProps: q, refreshButtonProps: M }) : m : Y2), breadcrumb: typeof K < "u" ? import_react113.default.createElement(import_react113.default.Fragment, null, K) ?? void 0 : import_react113.default.createElement(Le, null), ...l ?? {} }, import_react113.default.createElement(spin_default, { spinning: s }, import_react113.default.createElement(card_default, { bordered: false, actions: f ? [import_react113.default.createElement(space_default, { key: "footer-buttons", wrap: true, ...g }, typeof f == "function" ? f({ defaultButtons: null }) : f)] : void 0, ...u ?? {} }, n2))));
}, "Show");
var rp = o2(({ value: e2, ...t }) => import_react114.default.createElement(typography_default.Text, { ...t }, e2), "TextField");
var ap = o2(({ value: e2, ...t }) => import_react115.default.createElement(tag_default, { ...t }, e2 == null ? void 0 : e2.toString()), "TagField");
var lp = o2(({ value: e2, ...t }) => import_react116.default.createElement(typography_default.Link, { href: `mailto:${e2}`, ...t }, e2), "EmailField");
var mp = o2(({ value: e2, imageTitle: t, ...r }) => import_react117.default.createElement(image_default, { ...r, src: e2, title: t }), "ImageField");
var Tp = o2(({ value: e2, valueLabelTrue: t = "true", valueLabelFalse: r = "false", trueIcon: s = import_react118.default.createElement(CheckOutlined_default, null), falseIcon: n2 = import_react118.default.createElement(CloseOutlined_default, null), ...i }) => import_react118.default.createElement(tooltip_default, { title: e2 ? t : r, ...i }, e2 ? import_react118.default.createElement("span", null, s) : import_react118.default.createElement("span", null, n2)), "BooleanField");
var Pp = o2(({ value: e2, locales: t, format: r = "L", ...s }) => {
  import_dayjs5.default.extend(import_localizedFormat.default);
  let n2 = import_dayjs5.default.locale();
  return import_react119.default.createElement(typography_default.Text, { ...s }, e2 ? (0, import_dayjs5.default)(e2).locale(t || n2).format(r) : "");
}, "DateField");
var Cp = o2(({ title: e2, src: t, ...r }) => import_react120.default.createElement(qt, { value: t, title: e2, ...r }, e2 ?? t), "FileField");
var qt = o2(({ children: e2, value: t, ...r }) => import_react121.default.createElement(typography_default.Link, { href: t, ...r }, e2 ?? t), "UrlField");
function Lp() {
...
var kp = o2(({ value: e2, locale: t, options: r, ...s }) => {
  let n2 = Number(e2);
  return import_react122.default.createElement(typography_default.Text, { ...s }, Lp() ? n2.toLocaleString(t, r) : n2);
}, "NumberField");
var Rp = o2(({ value: e2 = "" }) => import_react123.default.createElement(import_react_markdown.default, { remarkPlugins: [import_remark_gfm.default] }, e2), "MarkdownField");
var Hp = o2((e2) => {
  let { setSelectedKeys: t, confirm: r, clearFilters: s, mapValue: n2 = o2((m) => m, "mapValue"), selectedKeys: i, children: a } = e2, p = $(), c = o2(() => {
    s && s();
  }, "clearFilter"), u = o2(() => {
    let m;
    typeof i == "number" ? m = `${i}` : import_dayjs6.default.isDayjs(i) ? m = [i.toISOString()] : m = i, t(m), r == null || r();
  }, "onFilter"), l = o2((m) => {
    if (typeof m == "object") {
      if (Array.isArray(m)) {
        let x = n2(m, "onChange");
      ...
      let g = !m || !m.target || import_dayjs6.default.isDayjs(m) ? { target: { value: m } } : m, { target: y } = g, b = n2(y.value, "onChange");
      t(b);
      return;
    }
    let f = n2(m, "onChange");
    t(f);
  }, "onChange"), d = import_react124.default.Children.map(a, (m) => import_react124.default.isValidElement(m) ? import_react124.default.cloneElement(m, { onChange: l, value: n2(i, "value") }) : m);
  return import_react124.default.createElement("div", { style: { padding: 10, display: "flex", flexDirection: "column", alignItems: "flex-end" } }, import_react124.default.createElement("div", { style: { marginBottom: 15 } }, d), import_react124.default.createElement(space_default, null, import_react124.default.createElement(button_default, { type: "primary", size: "small", onClick: () => u() }, import_react124.default.createElement(FilterOutlined_default, null), " ", p("buttons.filter", "Filter")), import_react124.default.createElement(button_default, { danger: true, size: "small", onClick: () => c() }, p("buttons.clear", "Clear"))));
}, "FilterDropdown");
var Yp = o2(() => {
  let [e2, t] = (0, import_react125.useState)(), r = $(), { push: s } = Pe(), n2 = he(), i = se(), { resource: a, action: p } = Y();
  ...
  }, [a, p]), import_react125.default.createElement(result_default, { status: "404", title: "404", extra: import_react125.default.createElement(space_default, { direction: "vertical", size: "large" }, import_react125.default.createElement(space_default, null, import_react125.default.createElement(typography_default.Text, null, r("pages.error.404", "Sorry, the page you visited does not exist.")), e2 && import_react125.default.createElement(tooltip_default, { title: e2 }, import_react125.default.createElement(InfoCircleOutlined_default, {}))), import_react125.default.createElement(button_default, { type: "primary", onClick: () => {
    i === "legacy" ? s("/") : n2({ to: "/" });
...
var nl = o2(() => {
  let [e2] = form_default.useForm(), t = $(), r = ie(), { mutate: s, isLoading: n2 } = $t({ v3LegacyAuthProviderCompatible: !!(r != null && r.isLegacy) }), i = import_react126.default.createElement(typography_default.Title, { level: 3, style: qo }, t("pages.login.title", "Sign in your account"));
  return import_react126.default.createElement(layout_default, { style: jo }, import_react126.default.createElement(row_default, { justify: "center", align: "middle", style: { height: "100vh" } }, import_react126.default.createElement(col_default, { xs: 22 }, import_react126.default.createElement("div", { style: Wo }, import_react126.default.createElement("div", { style: Go }, import_react126.default.createElement("img", { src: "https://refine.ams3.cdn.digitaloceanspaces.com/logo/refine.svg", alt: "Refine Logo" })), import_react126.default.createElement(card_default, { title: i, headStyle: { borderBottom: 0 } }, import_react126.default.createElement(form_default, { layout: "vertical", form: e2, onFinish: (a) => {
    s(a);
  }, requiredMark: false, initialValues: { remember: false } }, import_react126.default.createElement(form_default.Item, { name: "username", label: t("pages.login.username", "Username"), rules: [{ required: true }] }, import_react126.default.createElement(input_default, { size: "large", placeholder: t("pages.login.username", "Username") })), import_react126.default.createElement(form_default.Item, { name: "password", label: t("pages.login.password", "Password"), rules: [{ required: true }], style: { marginBottom: "12px" } }, import_react126.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react126.default.createElement("div", { style: { marginBottom: "12px" } }, import_react126.default.createElement(form_default.Item, { name: "remember", valuePropName: "checked", noStyle: true }, import_react126.default.createElement(checkbox_default, { style: { fontSize: "12px" } }, t("pages.login.remember", "Remember me"))), import_react126.default.createElement("a", { style: { float: "right", fontSize: "12px" }, href: "#" }, t("pages.login.forgotPassword", "Forgot password?"))), import_react126.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: n2, block: true }, t("pages.login.signin", "Sign in"))), import_react126.default.createElement("div", { style: { marginTop: 8 } }, import_react126.default.createElement(typography_default.Text, { style: { fontSize: 12 } }, t("pages.login.noAccount", "Don’t have an account?"), " ", import_react126.default.createElement("a", { href: "#", style: { fontWeight: "bold" } }, t("pages.login.signup", "Sign up")))))))));
}, "LoginPage");
...
var Tl = o2(() => import_react127.default.createElement(dc, null), "WelcomePage");
var De = {};
...
var $t2 = o2(({ providers: e2, registerLink: t, forgotPasswordLink: r, rememberMe: s, contentProps: n2, wrapperProps: i, renderContent: a, formProps: p, title: c, hideForm: u, mutationVariables: l }) => {
  let { token: d } = theme_default.useToken(), [m] = form_default.useForm(), f = $(), g = se(), y = yt(), { Link: b } = le(), x = g === "legacy" ? b : y, h = ie(), { mutate: B, isLoading: C } = $t({ v3LegacyAuthProviderCompatible: !!(h != null && h.isLegacy) }), S = c === false ? null : import_react129.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, c ?? import_react129.default.createElement(be, { collapsed: false })), k = import_react129.default.createElement(typography_default.Title, { level: 3, style: { color: d.colorPrimaryTextHover, ...Ie } }, f("pages.login.title", "Sign in to your account")), F = o2(() => e2 && e2.length > 0 ? import_react129.default.createElement(import_react129.default.Fragment, null, e2.map((T) => import_react129.default.createElement(button_default, { key: T.name, type: "default", block: true, icon: T.icon, style: { display: "flex", justifyContent: "center", alignItems: "center", width: "100%", marginBottom: "8px" }, onClick: () => B({ ...l, providerName: T.name }) }, T.label)), !u && import_react129.default.createElement(divider_default, null, import_react129.default.createElement(typography_default.Text, { style: { color: d.colorTextLabel } }, f("pages.login.divider", "or")))) : null, "renderProviders"), D = import_react129.default.createElement(card_default, { title: k, headStyle: we, bodyStyle: Re, style: { ...Ee, backgroundColor: d.colorBgElevated }, ...n2 ?? {} }, F(), !u && import_react129.default.createElement(form_default, { layout: "vertical", form: m, onFinish: (T) => B({ ...T, ...l }), requiredMark: false, initialValues: { remember: false }, ...p }, import_react129.default.createElement(form_default.Item, { name: "email", label: f("pages.login.fields.email", "Email"), rules: [{ required: true, message: f("pages.login.errors.requiredEmail", "Email is required") }, { type: "email", message: f("pages.login.errors.validEmail", "Invalid email address") }] }, import_react129.default.createElement(input_default, { size: "large", placeholder: f("pages.login.fields.email", "Email") })), import_react129.default.createElement(form_default.Item, { name: "password", label: f("pages.login.fields.password", "Password"), rules: [{ required: true, message: f("pages.login.errors.requiredPassword", "Password is required") }] }, import_react129.default.createElement(input_default, { type: "password", autoComplete: "current-password", placeholder: "●●●●●●●●", size: "large" })), import_react129.default.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: "24px" } }, s ?? import_react129.default.createElement(form_default.Item, { name: "remember", valuePropName: "checked", noStyle: true }, import_react129.default.createElement(checkbox_default, { style: { fontSize: "12px" } }, f("pages.login.buttons.rememberMe", "Remember me"))), r ?? import_react129.default.createElement(x, { style: { color: d.colorPrimaryTextHover, fontSize: "12px", marginLeft: "auto" }, to: "/forgot-password" }, f("pages.login.buttons.forgotPassword", "Forgot password?"))), !u && import_react129.default.createElement(form_default.Item, null, import_react129.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: C, block: true }, f("pages.login.signin", "Sign in")))), t ?? import_react129.default.createElement("div", { style: { marginTop: u ? 16 : 8 } }, import_react129.default.createElement(typography_default.Text, { style: { fontSize: 12 } }, f("pages.login.buttons.noAccount", "Don’t have an account?"), " ", import_react129.default.createElement(x, { to: "/register", style: { fontWeight: "bold", color: d.colorPrimaryTextHover } }, f("pages.login.signup", "Sign up")))));
  return import_react129.default.createElement(layout_default, { style: De, ...i ?? {} }, import_react129.default.createElement(row_default, { justify: "center", align: u ? "top" : "middle", style: { padding: "16px 0", minHeight: "100dvh", paddingTop: u ? "15dvh" : "16px" } }, import_react129.default.createElement(col_default, { xs: 22 }, a ? a(D, S) : import_react129.default.createElement(import_react129.default.Fragment, null, S, D))));
}, "LoginPage");
var Yt = o2(({ providers: e2, loginLink: t, wrapperProps: r, contentProps: s, renderContent: n2, formProps: i, title: a, hideForm: p, mutationVariables: c }) => {
  let { token: u } = theme_default.useToken(), [l] = form_default.useForm(), d = $(), m = se(), f = yt(), { Link: g } = le(), y = m === "legacy" ? g : f, b = ie(), { mutate: x, isLoading: h } = co({ v3LegacyAuthProviderCompatible: !!(b != null && b.isLegacy) }), B = a === false ? null : import_react130.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, a ?? import_react130.default.createElement(be, { collapsed: false })), C = import_react130.default.createElement(typography_default.Title, { level: 3, style: { color: u.colorPrimaryTextHover, ...Ie } }, d("pages.register.title", "Sign up for your account")), S = o2(() => e2 && e2.length > 0 ? import_react130.default.createElement(import_react130.default.Fragment, null, e2.map((F) => import_react130.default.createElement(button_default, { key: F.name, type: "default", block: true, icon: F.icon, style: { display: "flex", justifyContent: "center", alignItems: "center", width: "100%", marginBottom: "8px" }, onClick: () => x({ ...c, providerName: F.name }) }, F.label)), !p && import_react130.default.createElement(divider_default, null, import_react130.default.createElement(typography_default.Text, { style: { color: u.colorTextLabel } }, d("pages.register.divider", d("pages.login.divider", "or"))))) : null, "renderProviders"), k = import_react130.default.createElement(card_default, { title: C, headStyle: we, bodyStyle: Re, style: { ...Ee, backgroundColor: u.colorBgElevated }, ...s ?? {} }, S(), !p && import_react130.default.createElement(form_default, { layout: "vertical", form: l, onFinish: (F) => x({ ...c, ...F }), requiredMark: false, ...i }, import_react130.default.createElement(form_default.Item, { name: "email", label: d("pages.register.email", "Email"), rules: [{ required: true, message: d("pages.register.errors.requiredEmail", "Email is required") }, { type: "email", message: d("pages.register.errors.validEmail", "Invalid email address") }] }, import_react130.default.createElement(input_default, { size: "large", placeholder: d("pages.register.fields.email", "Email") })), import_react130.default.createElement(form_default.Item, { name: "password", label: d("pages.register.fields.password", "Password"), rules: [{ required: true, message: d("pages.register.errors.requiredPassword", "Password is required") }] }, import_react130.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react130.default.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: "24px" } }, t ?? import_react130.default.createElement(typography_default.Text, { style: { fontSize: 12, marginLeft: "auto" } }, d("pages.register.buttons.haveAccount", d("pages.login.buttons.haveAccount", "Have an account?")), " ", import_react130.default.createElement(y, { style: { fontWeight: "bold", color: u.colorPrimaryTextHover }, to: "/login" }, d("pages.register.signin", d("pages.login.signin", "Sign in"))))), import_react130.default.createElement(form_default.Item, { style: { marginBottom: 0 } }, import_react130.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: h, block: true }, d("pages.register.buttons.submit", "Sign up")))), p && t !== false && import_react130.default.createElement("div", { style: { marginTop: p ? 16 : 8 } }, import_react130.default.createElement(typography_default.Text, { style: { fontSize: 12 } }, d("pages.register.buttons.haveAccount", d("pages.login.buttons.haveAccount", "Have an account?")), " ", import_react130.default.createElement(y, { style: { fontWeight: "bold", color: u.colorPrimaryTextHover }, to: "/login" }, d("pages.register.signin", d("pages.login.signin", "Sign in"))))));
  return import_react130.default.createElement(layout_default, { style: De, ...r ?? {} }, import_react130.default.createElement(row_default, { justify: "center", align: p ? "top" : "middle", style: { padding: "16px 0", minHeight: "100dvh", paddingTop: p ? "15dvh" : "16px" } }, import_react130.default.createElement(col_default, { xs: 22 }, n2 ? n2(k, B) : import_react130.default.createElement(import_react130.default.Fragment, null, B, k))));
}, "RegisterPage");
var _t = o2(({ loginLink: e2, wrapperProps: t, contentProps: r, renderContent: s, formProps: n2, title: i, mutationVariables: a }) => {
  let { token: p } = theme_default.useToken(), [c] = form_default.useForm(), u = $(), l = se(), d = yt(), { Link: m } = le(), f = l === "legacy" ? m : d, { mutate: g, isLoading: y } = lo(), b = i === false ? null : import_react131.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, i ?? import_react131.default.createElement(be, { collapsed: false })), x = import_react131.default.createElement(typography_default.Title, { level: 3, style: { color: p.colorPrimaryTextHover, ...Ie } }, u("pages.forgotPassword.title", "Forgot your password?")), h = import_react131.default.createElement(card_default, { title: x, headStyle: we, bodyStyle: Re, style: { ...Ee, backgroundColor: p.colorBgElevated }, ...r ?? {} }, import_react131.default.createElement(form_default, { layout: "vertical", form: c, onFinish: (B) => g({ ...B, ...a }), requiredMark: false, ...n2 }, import_react131.default.createElement(form_default.Item, { name: "email", label: u("pages.forgotPassword.fields.email", "Email"), rules: [{ required: true, message: u("pages.forgotPassword.errors.requiredEmail", "Email is required") }, { type: "email", message: u("pages.forgotPassword.errors.validEmail", "Invalid email address") }] }, import_react131.default.createElement(input_default, { type: "email", size: "large", placeholder: u("pages.forgotPassword.fields.email", "Email") })), import_react131.default.createElement("div", { style: { display: "flex", justifyContent: "space-between" } }, e2 ?? import_react131.default.createElement(typography_default.Text, { style: { fontSize: 12, marginLeft: "auto" } }, u("pages.forgotPassword.buttons.haveAccount", u("pages.register.buttons.haveAccount", "Have an account? ")), " ", import_react131.default.createElement(f, { style: { fontWeight: "bold", color: p.colorPrimaryTextHover }, to: "/login" }, u("pages.forgotPassword.signin", u("pages.login.signin", "Sign in"))))), import_react131.default.createElement(form_default.Item, { style: { marginTop: "24px", marginBottom: 0 } }, import_react131.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: y, block: true }, u("pages.forgotPassword.buttons.submit", "Send reset instructions")))));
  return import_react131.default.createElement(layout_default, { style: De, ...t ?? {} }, import_react131.default.createElement(row_default, { justify: "center", align: "middle", style: { padding: "16px 0", minHeight: "100dvh" } }, import_react131.default.createElement(col_default, { xs: 22 }, s ? s(h, b) : import_react131.default.createElement(import_react131.default.Fragment, null, b, h))));
}, "ForgotPasswordPage");
var Zt = o2(({ wrapperProps: e2, contentProps: t, renderContent: r, formProps: s, title: n2, mutationVariables: i }) => {
  let { token: a } = theme_default.useToken(), [p] = form_default.useForm(), c = $(), u = ie(), { mutate: l, isLoading: d } = fo({ v3LegacyAuthProviderCompatible: !!(u != null && u.isLegacy) }), m = n2 === false ? null : import_react132.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, n2 ?? import_react132.default.createElement(be, { collapsed: false })), f = import_react132.default.createElement(typography_default.Title, { level: 3, style: { color: a.colorPrimaryTextHover, ...Ie } }, c("pages.updatePassword.title", "Set New Password")), g = import_react132.default.createElement(card_default, { title: f, headStyle: we, bodyStyle: Re, style: { ...Ee, backgroundColor: a.colorBgElevated }, ...t ?? {} }, import_react132.default.createElement(form_default, { layout: "vertical", form: p, onFinish: (y) => l({ ...y, ...i }), requiredMark: false, ...s }, import_react132.default.createElement(form_default.Item, { name: "password", label: c("pages.updatePassword.fields.password", "New Password"), rules: [{ required: true, message: c("pages.updatePassword.errors.requiredPassword", "Password is required") }], style: { marginBottom: "12px" } }, import_react132.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react132.default.createElement(form_default.Item, { name: "confirmPassword", label: c("pages.updatePassword.fields.confirmPassword", "Confirm New Password"), hasFeedback: true, dependencies: ["password"], rules: [{ required: true, message: c("pages.updatePassword.errors.requiredConfirmPassword", "Confirm password is required") }, ({ getFieldValue: y }) => ({ validator(b, x) {
    return !x || y("password") === x ? Promise.resolve() : Promise.reject(new Error(c("pages.updatePassword.errors.confirmPasswordNotMatch", "Passwords do not match")));
  } })] }, import_react132.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react132.default.createElement(form_default.Item, { style: { marginBottom: 0 } }, import_react132.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: d, block: true }, c("pages.updatePassword.buttons.submit", "Update")))));
  return import_react132.default.createElement(layout_default, { style: De, ...e2 ?? {} }, import_react132.default.createElement(row_default, { justify: "center", align: "middle", style: { padding: "16px 0", minHeight: "100dvh" } }, import_react132.default.createElement(col_default, { xs: 22 }, r ? r(g, m) : import_react132.default.createElement(import_react132.default.Fragment, null, m, g))));
}, "UpdatePasswordPage");
var dd = o2((e2) => {
  let { type: t } = e2;
  return import_react128.default.createElement(import_react128.default.Fragment, null, o2(() => {
    switch (t) {
      case "register":
        return import_react128.default.createElement(Yt, { ...e2 });
      case "forgotPassword":
        return import_react128.default.createElement(_t, { ...e2 });
      case "updatePassword":
        return import_react128.default.createElement(Zt, { ...e2 });
      default:
        return import_react128.default.createElement($t2, { ...e2 });
    }
  }, "renderView")());
}, "AuthPage");
var Le = o2(({ breadcrumbProps: e2, showHome: t = true, hideIcons: r = false, meta: s }) => {
  let n2 = se(), { breadcrumbs: i } = lb({ meta: s }), a = yt(), { Link: p } = le(), { hasDashboard: c } = ge(), { resources: u } = Y(), l = as("/", u), d = n2 === "legacy" ? p : a;
  if (i.length === 1) return null;
  let m = i.map(({ label: g, icon: y, href: b }) => ({ key: `breadcrumb-item-${g}`, title: import_react133.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", gap: 4 } }, !r && y, b ? import_react133.default.createElement(d, { to: b }, g) : import_react133.default.createElement("span", null, g)) }));
  return import_react133.default.createElement(breadcrumb_default, { items: o2(() => {
    var g, y;
    return t && (c || l.found) ? [{ key: "breadcrumb-item-home", title: import_react133.default.createElement(d, { to: "/" }, ((y = (g = l == null ? void 0 : l.resource) == null ? void 0 : g.meta) == null ? void 0 : y.icon) ?? import_react133.default.createElement(HomeOutlined_default, null)) }, ...m] : m;
  }, "getBreadcrumbItems")(), ...e2 });
}, "Breadcrumb");
var ke = o2(({ children: e2, ...t }) => {
  var p;
  let r = (p = (0, import_react134.useContext)(config_provider_default.ConfigContext)) == null ? void 0 : p.direction, s = o2(() => import_react134.default.createElement(button_default, { type: "text", icon: import_react134.default.createElement(r === "rtl" ? ArrowRightOutlined_default : ArrowLeftOutlined_default, null) }), "renderBackButton"), n2 = typeof t.backIcon > "u" ? s() : t.backIcon, i = typeof t.title == "string" ? import_react134.default.createElement(typography_default.Title, { className: o.Title, level: 4, style: { marginBottom: 0 } }, t.title) : t.title, a = typeof t.title == "string" ? import_react134.default.createElement(typography_default.Title, { className: o.SubTitle, level: 5, type: "secondary", style: { marginBottom: 0 } }, t.subTitle) : t.subTitle;
  return import_react134.default.createElement(PageHeader, { ...t, backIcon: n2, title: i, subTitle: a, style: { padding: 0, ...t.style } }, e2);
}, "PageHeader");
var Oo = o2(({ status: e2, elements: { success: t = import_react135.default.createElement(ut, { translationKey: "autoSave.success", defaultMessage: "saved", icon: import_react135.default.createElement(CheckCircleOutlined_default, null) }), error: r = import_react135.default.createElement(ut, { translationKey: "autoSave.error", defaultMessage: "auto save failure", icon: import_react135.default.createElement(ExclamationCircleOutlined_default, null) }), loading: s = import_react135.default.createElement(ut, { translationKey: "autoSave.loading", defaultMessage: "saving...", icon: import_react135.default.createElement(SyncOutlined_default, null) }), idle: n2 = import_react135.default.createElement(ut, { translationKey: "autoSave.idle", defaultMessage: "waiting for changes", icon: import_react135.default.createElement(EllipsisOutlined_default, null) }) } = {} }) => import_react135.default.createElement(Fc, { status: e2, elements: { success: t, error: r, loading: s, idle: n2 } }), "AutoSaveIndicator");
var ut = o2(({ translationKey: e2, defaultMessage: t, icon: r }) => {
  let s = $(), { token: n2 } = theme_default.useToken();
  return import_react135.default.createElement(typography_default.Text, { style: { marginRight: 5, color: n2.colorTextTertiary, fontSize: ".8rem" } }, s(e2, t), import_react135.default.createElement("span", { style: { marginLeft: ".2rem" } }, r));
}, "Message");
...
var aP = { Blue: { token: { colorPrimary: "#1677FF" } }, Purple: { token: { colorPrimary: "#722ED1" } }, Magenta: { token: { colorPrimary: "#EB2F96" } }, Red: { token: { colorPrimary: "#F5222D" } }, Orange: { token: { colorPrimary: "#FA541C" } }, Yellow: { token: { colorPrimary: "#FAAD14" } }, Green: { token: { colorPrimary: "#52C41A" } } };
export {
  dd as AuthPage,
